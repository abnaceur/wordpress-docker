...
if ( 'posts' == get_option( 'show_on_front' ) ){ 
    get_header(); ?>
    <?php $enabled_sections = creativ_blog_get_sections();
    if( is_array( $enabled_sections ) ) {
        foreach( $enabled_sections as $section ) {

            if( ( $section['id'] == 'featured-slider' ) ){ ?>
                <?php $disable_featured_slider = creativ_blog_get_option( 'disable_featured_slider' );
            ...
            <?php } elseif( $section['id'] == 'about-author' ) { ?>
                <?php $disable_about_author_section = creativ_blog_get_option( 'disable_about_author_section' );
