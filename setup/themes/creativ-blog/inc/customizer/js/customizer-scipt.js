...
*/
 jQuery(document).ready(function($) {
    $('#customize-control-theme_options-layout_options_blog #creativ-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_blog #creativ-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-blog-radio-img-selected') ;
        });
        $(this).addClass ('creativ-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #creativ-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_archive #creativ-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-blog-radio-img-selected') ;
        });
        $(this).addClass ('creativ-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #creativ-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_page #creativ-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-blog-radio-img-selected') ;
        });
        $(this).addClass ('creativ-blog-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #creativ-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_single #creativ-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-blog-radio-img-selected') ;
        });
        $(this).addClass ('creativ-blog-radio-img-selected') ;
    });   

    $('#customize-control-theme_options-layout_options_boxed #creativ-blog-img-container li label img').click(function(){    	
        $('#customize-control-theme_options-layout_options_boxed #creativ-blog-img-container li').each(function(){
            $(this).find('img').removeClass ('creativ-blog-radio-img-selected') ;
        });
        $(this).addClass ('creativ-blog-radio-img-selected') ;
    });                    
