...
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'creativ-blog' ),
	'priority'   => 100,
...
'title'       => __('General Option', 'creativ-blog'),
...
$wp_customize->add_control(new creativ_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Layout Option For Blog', 'creativ-blog'),
...
$wp_customize->add_control(new creativ_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Layout Option For Archive', 'creativ-blog'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new creativ_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Layout Option For Pages', 'creativ-blog'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new creativ_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Layout Option For Single Posts', 'creativ-blog'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new creativ_blog_Image_Radio_Control($wp_customize, 'theme_options[layout_options_boxed]', 
	array(		
	'label' 	=> __('Full Width/Boxed/Frame Layout', 'creativ-blog'),
	'section' 	=> 'section_general',
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'creativ_blog_sanitize_textarea_content',
	'transport'         => 'postMessage',
	)
);
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'creativ-blog' ),
	'section'  => 'section_general',
	'type'     => 'text',
	'priority' => 100,
	)
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'creativ_blog_sanitize_positive_integer',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => esc_html__( 'Excerpt Length', 'creativ-blog' ),
	'description' => esc_html__( 'in words', 'creativ-blog' ),
	'section'     => 'section_general',
	'type'        => 'number',
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'creativ-blog'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'creativ-blog' ),
...
$wp_customize->add_section( 
    ...
    array(
        'capability'  => 'edit_theme_options',
        'title'       => esc_html__( 'Header Image For Inner Pages', 'creativ-blog' ),
        'panel'       => 'theme_option_panel',
    ) 
);
...
$wp_customize->add_setting( 'theme_options[archive_header_image]',
    array(
        ...
        'sanitize_callback' => 'creativ_blog_sanitize_image',
    )
);
...
$wp_customize->add_control( 
    new WP_Customize_Image_Control( $wp_customize, 'theme_options[archive_header_image]',
        array(
            'label'         => esc_html__( 'Header Image For Archive Page', 'creativ-blog' ),
            'description'   => esc_html__( 'Choose Header Image of your choice for Archive Pages. Recommended size for this image is 1920px by 500px.', 'creativ-blog' ),
...
$wp_customize->add_control( 
    new WP_Customize_Image_Control( $wp_customize, 'theme_options[search_header_image]',
        array(
            'label'         => esc_html__( 'Header Image For Search Page', 'creativ-blog' ),
            'description'   => esc_html__( 'Choose Header Image of your choice for Search Page. Recommended size for this image is 1920px by 500px', 'creativ-blog' ),
            'section'       => 'custom_header_image_settings',
            'type'          => 'image',
        )
    )
...
$wp_customize->add_control( 
    new WP_Customize_Image_Control( $wp_customize, 'theme_options[404_header_image]',
        array(
            'label'         => esc_html__( 'Header Image For 404 Page', 'creativ-blog' ),
            'description'   => esc_html__( 'Choose Header Image of your choice for 404 Page. Recommended size for this image is 1920px by 500px', 'creativ-blog' ),
            'section'       => 'custom_header_image_settings',
            'type'          => 'image',
        )
    )
