...
if( ! class_exists( 'Vandana_Lite_Control_Repeater' ) ) {
    ...
    class Vandana_Lite_Control_Repeater extends WP_Customize_Control {
    	 ...
    	 * @var string
    	 */
    	public $type = 'vandana-lite-repeater';
    	...
    	public function enqueue() {    
            ...
            wp_enqueue_script( 'vandana-lite-repeater', get_template_directory_uri() . '/inc/custom-controls/repeater/repeater.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), false, true );
    		wp_enqueue_style( 'vandana-lite-repeater', get_template_directory_uri() . '/inc/custom-controls/repeater/repeater.css', null );
    	}
    					...
    					<# _.each( data, function( field, i ) { #>
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="vandana-lite-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'vandana-lite' ); ?>" >
    									<# if ( field.default ) { #>
    										<# var defaultImageURL = ( field.default.url ) ? field.default.url : field.default; #>
    										<img src="{{{ defaultImageURL }}}">
    									<# } else { #>
    										<?php esc_attr_e( 'No Image Selected', 'vandana-lite' ); ?>
    									<# } #>
    								</figure>
    								...
    								<div class="actions">
    									...
    									<button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'vandana-lite' ); ?>" data-alt-label="<?php esc_attr_e( 'Change Image', 'vandana-lite' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_attr_e( 'Change Image', 'vandana-lite' ); ?>
    										<# } else { #>
    											<?php esc_attr_e( 'Add Image', 'vandana-lite' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="vandana-lite-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'vandana-lite' ); ?>" >
    									<# if ( field.default ) { #>
    									...
    									<# } else { #>
    										<?php esc_attr_e( 'No File Selected', 'vandana-lite' ); ?>
    									<# } #>
    								</figure>
    								...
    								<div class="actions">
    									...
    									<button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'vandana-lite' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'vandana-lite' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_attr_e( 'Change File', 'vandana-lite' ); ?>
    										<# } else { #>
    											<?php esc_attr_e( 'Add File', 'vandana-lite' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    										<input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
