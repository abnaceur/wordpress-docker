...
while ( have_posts() ) : the_post();
    ...
    $related_title = get_theme_mod( 'related_portfolio_title', __( 'Related Projects', 'vandana-lite' ) );
                            ...
                            <div class="portfolio-item">
                    			<div class="portfolio-item-inner">
                    				<a href="<?php the_permalink(); ?>">
                    					<?php the_post_thumbnail( 'vandana-lite-blog', array( 'itemprop' => 'image' ) ); ?>
                    				</a>
