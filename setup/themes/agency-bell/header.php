...
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'agencybell' ); ?></a>
...
<?php
     ...
     * Header Type
    */
    $headerlayout = get_theme_mod('construction_light_header_layout','layout_three');
