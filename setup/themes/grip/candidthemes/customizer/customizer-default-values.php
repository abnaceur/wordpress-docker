...
if ( !function_exists('grip_default_theme_options_values') ) :
    function grip_default_theme_options_values() {
        $default_theme_options = array(
            ...
            /*Primary Color Default Value*/
            'grip-primary-color' => '#f88c00',

            /*logo position*/
            'grip-custom-logo-position'=> 'default',

            /*Site Layout Options*/
            'grip-site-layout-options'=>'boxed',
            ...
            'grip-enable-single-tags' => false,

            /*Sticky Sidebar Options*/
            'grip-enable-sticky-sidebar'=> true,

            /*Footer Section*/
            'grip-footer-copyright' =>  esc_html__('All Right Reserved 2020.','grip'),
            'grip-go-to-top'=> true,

            /*Font Options*/
            'grip-font-family-url'=>  'Muli:400,300italic,300',
            'grip-font-heading-family-url'=> 'Domine',
            'grip-font-paragraph-font-size'=> 16,
            
            /*Extra Options*/
            'grip-extra-breadcrumb'=> true,
            'grip-breadcrumb-text'=>  esc_html__('You are Here','grip'),
            'grip-extra-preloader'=> true,
