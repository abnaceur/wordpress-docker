...
$wp_customize->add_control( 'grip_options[grip-enable-ads-header]', array(
  ...
  'description' => sprintf('%1$s <a href="%2$s" target="_blank">%3$s</a> %4$s',
        __( 'Checked to Enable the header ads. You will get the option to add adsese code in', 'grip' ),
        esc_url('https://www.candidthemes.com/themes/grip-pro/'),
        __('Premium version' , 'grip'),
        __('and more options too.' ,'grip')
    ),
