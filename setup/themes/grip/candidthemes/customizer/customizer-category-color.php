...
foreach ($categories as $category_list ) {
    ...
    $wp_customize->add_setting('grip_options[cat-'.get_cat_id($wp_category_list[$category_list->cat_ID]).']', array(
    ...
    $wp_customize->add_control(
    	new WP_Customize_Color_Control(
    		$wp_customize,
		    'grip_options[cat-'.get_cat_id($wp_category_list[$category_list->cat_ID]).']',
		    array(
		    	'label'     => sprintf(__('"%s" Color', 'grip'), $wp_category_list[$category_list->cat_ID] ),
			    'section'   => 'grip_category_color_setting',
			    'settings'  => 'grip_options[cat-'.get_cat_id($wp_category_list[$category_list->cat_ID]).']',
			    'priority'  => $i,
