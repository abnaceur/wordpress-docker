...
/* Single Tags Hide*/
$wp_customize->add_setting( 'grip_options[grip-enable-single-tags]', array(
    'capability'        => 'edit_theme_options',
    'transport' => 'refresh',
    'default'           => $default['grip-enable-single-tags'],
    'sanitize_callback' => 'grip_sanitize_checkbox'
) );
$wp_customize->add_control( 'grip_options[grip-enable-single-tags]', array(
    'label'     => __( 'Enable Tags', 'grip' ),
    'description' => __('Checked to Tags In Single post and page.', 'grip'),
    'section'   => 'grip_single_page_section',
    'settings'  => 'grip_options[grip-enable-single-tags]',
    'type'      => 'checkbox',
    'priority'  => 20,
) );