...
/*Blog Page Tags*/
$wp_customize->add_setting( 'grip_options[grip-enable-blog-tags]', array(
    'capability'        => 'edit_theme_options',
    'transport' => 'refresh',
    'default'           => $default['grip-enable-blog-tags'],
    'sanitize_callback' => 'grip_sanitize_checkbox'
) );
$wp_customize->add_control( 'grip_options[grip-enable-blog-tags]', array(
    'label'     => __( 'Enable Tags', 'grip' ),
    'description' => __('Checked to Enable Tags in Blog,  Search Page and Archive page.', 'grip'),
    'section'   => 'grip_blog_page_section',
    'settings'  => 'grip_options[grip-enable-blog-tags]',
    'type'      => 'checkbox',
    'priority'  => 70,
) );
