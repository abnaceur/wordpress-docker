 ...
 */
function grip_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function grip_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function grip_sanitize_number_range( $number, $setting ) {
 ...
 *
 */
if ( !function_exists('grip_sanitize_image') ) :
	function grip_sanitize_image( $image, $setting ) {
		/*
