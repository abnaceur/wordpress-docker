...
if (!class_exists('Grip_Post_Slider')) :
    ...
    class Grip_Post_Slider extends WP_Widget
    {
        ...
        function widget($args, $instance)
        {
            ...
            $grip_slider_args = array();
            if(is_rtl()){
                $grip_slider_args['rtl']      = true;
            }
            $grip_slider_args_encoded = wp_json_encode( $grip_slider_args );
            ...
            <div class="grip-slider-container">
                <section class="section-slider">
                    <div class="header-carousel">
                        <ul class="ct-post-carousel slider"  data-slick='<?php echo $grip_slider_args_encoded; ?>'>
                            <?php
