<?php
/**
 * Grip Grid Post Widget.
 *
 * @since 1.0.0
 */
if (!class_exists('Grip_Grid_Post')) :
     ...
     * @since 1.0.0
     */
    class Grip_Grid_Post extends WP_Widget
    {

        function __construct()
        {
            $opts = array(
                'classname' => 'grip-grid-post',
                'description' => esc_html__('Help to display content in Grid Layout.', 'grip'),
            );

            parent::__construct('grip-grid-post', esc_html__('Grip Grid Post', 'grip'), $opts);
        }
