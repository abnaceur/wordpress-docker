...
if (!class_exists('Grip_Category_Column')) {
    ...
    class Grip_Category_Column extends WP_Widget
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $cat_id_1 = $instance['cat_id_1'] ? absint($instance['cat_id_1']): 1;
        ...
        public function update($new_instance, $old_instance)
        {
            ...
            $instance['cat_id_1'] = (isset($new_instance['cat_id_1'])) ? absint($new_instance['cat_id_1']) : 1;
            $instance['cat_id_2'] = (isset($new_instance['cat_id_2'])) ? absint($new_instance['cat_id_2']) : 1;
