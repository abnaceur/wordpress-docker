...
jQuery(document).ready(function ($) {
	...
	$(".install").on('click', function (e) {
    	...
    	var ajaxurl = CandidWelcomeObject.ajaxurl;
		...
		$.ajax({
			...
			data: {
				...
				nonce: CandidWelcomeObject.admin_nonce,
			},
			success: function(response) {
		   		...
		   		if(response == 'success'){
				   		...
				   		el.html(CandidWelcomeObject.installed_btn);
	...
	$(".plugin-action-btn .activate").on('click', function (e) {
		...
		$.ajax({
	   		...
	   		data: {
	   			...
	   			plugin: plugin,
	   			plugin_file: plugin_file,
	   			nonce: CandidWelcomeObject.activate_nonce,
	   			dataType: 'json'
	   		},
	   		success: function(response) {
	   			el.removeClass('installing');
	...
	$(".plugin-action-btn .deactivate").on('click', function (e) {
		...
		$.ajax({
	   		...
	   		data: {
	   			...
	   			plugin: plugin,
	   			plugin_file: plugin_file,
	   			nonce: CandidWelcomeObject.deactivate_nonce,
	   			dataType: 'json'
	   		},
	   		success: function(response) {
	   			el.removeClass('installing');
