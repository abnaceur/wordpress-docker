...
if (!class_exists('Magazine_Prime_widget_style_1')) :
    ...
    class Magazine_Prime_widget_style_1 extends Magazine_Prime_Widget_Base
    {
        ...
        function widget($args, $instance)
        {
            ...
            $style_1_query = new WP_Query($qargs);
            if ($style_1_query->have_posts()) : 

            $count = 1;
            ?>
            <div class="twp-widget-wrapper clearfix">
                <?php while ($style_1_query->have_posts()) :
                        $style_1_query->the_post();
                    if ($count == 1) { ?>
                        ...
                        <div class="col-half col-half-left">
                            <div class="featured-article">
                                ...
                                $thumb = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'magazine-prime-400-505' );
                                $url = $thumb['0'];
                                } else {
...
if (!class_exists('Magazine_Prime_widget_style_2')) :
    ...
    class Magazine_Prime_widget_style_2 extends Magazine_Prime_Widget_Base
    {
        ...
        function widget($args, $instance)
        {
            ...
            $style_2_query = new WP_Query($qargs);
            if ($style_2_query->have_posts()) :
            ?>
            <div class="twp-widget-wrapper clearfix">
                <?php while ($style_2_query->have_posts()) :
                    $style_2_query->the_post(); ?>
                                        ...
                                        <span class="author-avatar">
                                            ...
                                            <?php if (!empty($post_author_url)) : ?>
                                                <a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) )) ?>">
                                                    <?php echo get_avatar( get_the_author_meta( 'ID' ),20); ?></a>
                                            <?php else : ?>
...
if (!class_exists('Magazine_Prime_sidebar_widget')) :
    ...
    class Magazine_Prime_sidebar_widget extends Magazine_Prime_Widget_Base
    {
        ...
        function widget($args, $instance)
        {
            ...
            $style_popular_posts_query = new WP_Query($qargs);
            

            $count = 1;
            
            if ($style_popular_posts_query->have_posts()) : ?>

            <div class="twp-recent-widget">                
                <ul class="recent-widget-list">

                <?php while ($style_popular_posts_query->have_posts()) :
                    $style_popular_posts_query->the_post(); ?>
...
if (!class_exists('Magazine_Prime_Tabbed_Widget')) :
    ...
    class Magazine_Prime_Tabbed_Widget extends Magazine_Prime_Widget_Base
    {
                    ...
                    <ul class="nav nav-tabs section-title" role="tablist">
                        <li role="presentation" class="tab tab-popular active">
                            <a href="#<?php echo esc_attr($tab_id); ?>-popular"
                               aria-controls="<?php esc_attr_e('Popular', 'magazine-prime'); ?>" role="tab"
                               data-toggle="tab">
                        ...
                        <li class="tab tab-recent">
                            <a href="#<?php echo esc_attr($tab_id); ?>-recent"
                               aria-controls="<?php esc_attr_e('Recent', 'magazine-prime'); ?>" role="tab" data-toggle="tab">
                                <?php esc_html_e('Recent', 'magazine-prime'); ?>
                            </a>
                        </li>
                        <li class="tab tab-comments">
                            <a href="#<?php echo esc_attr($tab_id); ?>-comments"
                               aria-controls="<?php esc_attr_e('Comments', 'magazine-prime'); ?>" role="tab"
                               data-toggle="tab">
        ...
        function render_news($type, $params)
        {
            ...
            $style_tab_postsquery = new WP_Query($qargs);
            if ($style_tab_postsquery->have_posts()) : ?>

                <ul class="article-item article-list-item article-tabbed-list article-item-left">
                    <?php while ($style_tab_postsquery->have_posts()) :
                        $style_tab_postsquery->the_post(); ?>
