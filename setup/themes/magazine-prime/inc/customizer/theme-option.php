...
$wp_customize->add_section( 'theme_option_header_settings',
	array(
		'title'      => esc_html__( 'Header Setting', 'magazine-prime' ),
		'priority'   => 100,
		'capability' => 'edit_theme_options',
...
$wp_customize->add_control( 'enable_header_search',
	array(
		'label'    => esc_html__( 'Enable Header Search', 'magazine-prime' ),
...
// Pre Loader Section.
$wp_customize->add_section( 'pare_loader_section',
	array(
	'title'      => esc_html__( 'Pre-Loader Options', 'magazine-prime' ),
	'priority'   => 110,
	'capability' => 'edit_theme_options',
	'panel'      => 'theme_option_panel',
	)
...
// Setting enable_pre_loader.
$wp_customize->add_setting( 'enable_pre_loader',
	array(
	'default'           => $default['enable_pre_loader'],
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'magazine_prime_sanitize_checkbox',
	)
);
$wp_customize->add_control( 'enable_pre_loader',
	array(
	'label'       => esc_html__( 'Enable Preloader', 'magazine-prime' ),
	'section'     => 'pare_loader_section',
	'type'        => 'checkbox',
	'priority'    => 100,
	)
);
...
$wp_customize->add_control( 'enable_footer_scroll_top',
	array(
		'label'    => esc_html__( 'Enable Scroll To Top Button', 'magazine-prime' ),
		'section'  => 'footer_section',
		'type'     => 'checkbox',
...
$wp_customize->add_section('single_post_setting',
	array(
		'title'      => esc_html__('Single Posts', 'magazine-prime'),
		'priority'   => 120,
		'capability' => 'edit_theme_options',
		'panel'      => 'theme_option_panel',
	)
...
$wp_customize->add_control('ed_floating_next_previous_nav',
    array(
        'label' => esc_html__('Enable Fixed Floating Next/Previous Articles', 'magazine-prime'),
