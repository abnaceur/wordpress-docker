...
function magazine_prime_admin_scripts($hook) {
	...
	wp_enqueue_style('magazine-prime-admin', get_template_directory_uri() . '/assets/twp/css/admin.css', array(), '1.0.0');

	if ('widgets.php' === $hook) {
		wp_enqueue_media();
		wp_enqueue_script('magazine-prime-widgets', get_template_directory_uri().'/assets/twp/js/widgets.js', array('jquery'), '1.0.0', true);
	}
