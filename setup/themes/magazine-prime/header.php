...
<?php
$mp_preloader = magazine_prime_get_option('enable_pre_loader');
if ($mp_preloader == 1) {?>
...
<div id="page" class="site site-bg <?php echo esc_attr($magazine_prime_homepage_layout); ?>">
    ...
    <header id="masthead" class="site-header site-header-second" role="banner">
        ...
        $enable_header_search = absint(magazine_prime_get_option('enable_header_search'));
        ?>
            <div class="container">
                ...
                <?php if( $navigation_collaps_enable == 1 || $enable_header_search ) { ?>
            ...
            <?php if( $enable_header_search ){ ?>
                <div class="search-box alt-bordercolor"> <?php get_search_form(); ?>  <a class="search-box-render screen-reader-text" href="javascript:void(0)"></a></div>
            <?php } ?>
                        ...
                        <div class="col-sm-12">
                            <div class="news-ticker-wrapper">
                                ...
                                <div class="news-ticker-headline">
                                    <h2 class="alt-bgcolor"><?php esc_html_e('Trending News', 'magazine-prime'); ?></h2>
                                </div>
                                ...
                                if ($magazine_prime_tinker_post_query->have_posts()) :
                                    ...
                                    <div class="news-ticker" data-slick='{"rtl": <?php echo($rtl_class); ?>}'>
