						...
						<div class="kata-post-content">
							...
							<?php if ( has_tag() && $kata_post_single_tags ) : ?>
								<div class="kata-post-tags">
									<span><?php echo esc_html__( 'Tags : ', 'kata-app' ); ?></span> <?php Kata_Template_Tags::post_tags(); ?>
								</div>
							<?php endif; ?>
							<?php if ( $kata_post_single_socials ) : ?>
								<div class="kata-post-social-share">
									<span class="kata-post-social-share-title"><?php echo esc_html__( 'Share : ', 'kata-app' ); ?></span>
