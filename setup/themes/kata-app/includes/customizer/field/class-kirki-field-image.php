...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'kata-app' ),
				'change'       => esc_html__( 'Change image', 'kata-app' ),
				'default'      => esc_html__( 'Default', 'kata-app' ),
				'remove'       => esc_html__( 'Remove', 'kata-app' ),
				'placeholder'  => esc_html__( 'No image selected', 'kata-app' ),
				'frame_title'  => esc_html__( 'Select image', 'kata-app' ),
				'frame_button' => esc_html__( 'Choose image', 'kata-app' ),
			)
		);
	}
