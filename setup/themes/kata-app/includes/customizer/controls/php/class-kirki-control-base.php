	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'kata-app' ),
				'remove'               => esc_html__( 'Remove', 'kata-app' ),
				'default'              => esc_html__( 'Default', 'kata-app' ),
				'selectFile'           => esc_html__( 'Select File', 'kata-app' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'kata-app' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'kata-app' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'kata-app' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'kata-app' ),
			)
		);
