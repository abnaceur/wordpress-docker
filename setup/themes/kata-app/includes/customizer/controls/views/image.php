...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'kata-app' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'kata-app' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'kata-app' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'kata-app' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'kata-app' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'kata-app' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'kata-app' ); ?>',
} );
#>
