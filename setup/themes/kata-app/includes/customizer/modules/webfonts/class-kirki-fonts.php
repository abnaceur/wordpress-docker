...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'kata-app' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'kata-app' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'kata-app' ),
			'200'       => esc_html__( 'Light 200', 'kata-app' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'kata-app' ),
			'300'       => esc_html__( 'Book 300', 'kata-app' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'kata-app' ),
			'400'       => esc_html__( 'Normal 400', 'kata-app' ),
			'regular'   => esc_html__( 'Normal 400', 'kata-app' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'kata-app' ),
			'500'       => esc_html__( 'Medium 500', 'kata-app' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'kata-app' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'kata-app' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'kata-app' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'kata-app' ),
			'700'       => esc_html__( 'Bold 700', 'kata-app' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'kata-app' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'kata-app' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'kata-app' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'kata-app' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'kata-app' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'kata-app' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'kata-app' ),
		);
	}
