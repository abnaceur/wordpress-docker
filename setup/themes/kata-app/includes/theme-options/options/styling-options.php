	...
	class Kata_Theme_Options_Styling_Typography extends Kata_Theme_Options {
		...
		public static function set_options() {
			...
			Kirki::add_panel(
				...
				[
					'title'      => esc_html__( 'Styling', 'kata-app' ),
					'icon'       => 'ti-palette',
			...
			Kirki::add_section(
				...
				[
					...
					'title'      => esc_html__( 'Basic Typography', 'kata-app' ),
					'capability' => 'manage_options',
					'priority'   => 8,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Body Typography', 'kata-app' ),
					'description' => esc_html__( 'Controls the typography of body.', 'kata-app' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-app' ),
						'enabel'	=> esc_html__( 'Enabel', 'kata-app' ),
					],
				]
			);
			Kirki::add_field(
				...
				[
					...
					'type'		=> 'select',
					'default'	=> 'select-font',
					'label'		=> esc_html__( 'Font Family', 'kata-app' ),
			...
			Kirki::add_field(
				...
				[
					...
					'section'	=> 'kata_body_typography_section',
					'type'		=> 'dimensions',
					'label'		=> esc_html__( 'Font Properties', 'kata-app' ),
					'default'	=> [
						'font-size'			=> '15px',
						'font-weight'		=> '400',
						'letter-spacing'	=> '0px',
			...
			Kirki::add_field(
				...
				[
					...
					'section'  => 'kata_body_typography_section',
					'type'     => 'color',
					'label'    => esc_html__('Color', 'kata-app'),
					'default'  => '',
					'choices'  => [
						'alpha' => true,
					],
			...
			Kirki::add_section(
				...
				[
					'panel'      => 'kata_styling_and_typography_panel',
					'title'      => esc_html__( 'Headings Typography', 'kata-app' ),
					'capability' => 'manage_options',
					'priority'   => 9,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Headings Typography', 'kata-app' ),
					'description' => esc_html__( 'Controls the typography of H1-H6.', 'kata-app' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-app' ),
			...
			Kirki::add_section(
				...
				[
					'panel'      => 'kata_styling_and_typography_panel',
					'title'      => esc_html__( 'Nav Menu Typography', 'kata-app' ),
					'capability' => 'manage_options',
					'priority'   => 9,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Nav Menu Typography', 'kata-app' ),
					'description' => esc_html__( 'Controls the typography of nav menu items.', 'kata-app' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-app' ),
			...
			Kirki::add_section(
				...
				[
					'title'      => esc_html__('Advanced Styling', 'kata-app'),
					'panel'      => 'kata_styling_and_typography_panel',
			...
			Kirki::add_field(
				...
				[
					...
					'label'    => esc_html__('Primary Color', 'kata-app'),
					'default'  => '',
					'choices'  => [
						'alpha' => true,
					],
			...
			Kirki::add_field(
				...
				[
					...
					'section'	=> 'kata_styling_typography_section',
					'type'		=> 'custom',
					'label'		=> esc_html__( 'To more options please install Kata Plus', 'kata-app' ),
					'default'	=> '
					<a href="' . esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) . '" target="_blank" class="button customizer-kata-builder-button button-large">
						<span class="elementor-switch-mode-off">' . esc_html__( 'Plugins Installer', 'kata-app' ) . '</span>
					</a>',
				]
			);
		}
