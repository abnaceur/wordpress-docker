		...
		public static function set_options() {
			Kirki::add_field(
				...
				[
					...
					'description' => esc_html__( 'Controls the site layout.', 'kata-app' ),
					'type'        => 'radio-buttonset',
					'default'     => 'kata-wide',
					'choices'     => [
						'kata-wide'  => esc_html__( 'Wide', 'kata-app' ),
						'kata-boxed' => esc_html__( 'Boxed', 'kata-app' ),
					],
				]
			);
			Kirki::add_field(
				...
				[
					...
					'section'     => 'title_tagline',
					'label'       => esc_html__( 'Responsive', 'kata-app' ),
					'description' => esc_html__( 'Disable this option in case you don\'t need a responsive website.', 'kata-app' ),
					'type'        => 'switch',
					'default'     => '1',
					'choices'     => [
