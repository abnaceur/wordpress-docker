...
<html <?php language_attributes(); ?>>
	...
	<?php if(get_theme_mod('digital_agency_lite_loader_enable',true)==1){ ?>
	  	<div id="preloader">
		    <div id="status">
		      <?php $digital_agency_lite_theme_lay = get_theme_mod( 'digital_agency_lite_loader_icon','Two Way');
		        if($digital_agency_lite_theme_lay == 'Two Way'){ ?>
		        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/two-way.gif" alt="" role="img"/>
		      <?php }else if($digital_agency_lite_theme_lay == 'Dots'){ ?>
		        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/dots.gif" alt="" role="img"/>
		      <?php }else if($digital_agency_lite_theme_lay == 'Rotate'){ ?>
