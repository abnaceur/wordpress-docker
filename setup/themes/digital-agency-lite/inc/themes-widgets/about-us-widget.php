...
class Digital_Agency_Lite_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Digital_Agency_Lite_About_Widget',
			__('VW About us', 'digital-agency-lite'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'digital-agency-lite' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','digital-agency-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','digital-agency-lite'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','digital-agency-lite'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','digital-agency-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','digital-agency-lite'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','digital-agency-lite'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function digital_agency_lite_about_custom_load_widget() {
	register_widget( 'Digital_Agency_Lite_About_Widget' );
}
add_action( 'widgets_init', 'digital_agency_lite_about_custom_load_widget' );