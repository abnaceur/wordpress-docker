...
class Digital_Agency_Lite_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'digital-agency-lite' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $digital_agency_lite_font_awesome_icon_array = digital_agency_lite_font_awesome_icon_array();
                    foreach ($digital_agency_lite_font_awesome_icon_array as $digital_agency_lite_font_awesome_icon) {
                            $icon_class = $this->value() == $digital_agency_lite_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($digital_agency_lite_font_awesome_icon).'"></i>
                            <span class="digital-agency-lite-social-class">'.esc_attr($digital_agency_lite_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function digital_agency_lite_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'digital-agency-lite-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'digital_agency_lite_customizer_script' );

if(!function_exists('digital_agency_lite_font_awesome_icon_array')){
    function digital_agency_lite_font_awesome_icon_array(){
