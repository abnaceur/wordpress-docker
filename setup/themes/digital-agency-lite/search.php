...
<div class="container">
    <main id="maincontent" class="middle-align" role="main">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','digital-agency-lite'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php
        ...
        if($digital_agency_lite_theme_lay == 'Left Sidebar'){ ?>
            <div class="row m-0">
                ...
                <div id="our-services" class="services col-lg-8 col-md-8">                    
                    ...
                    ?>
                    <?php if( get_theme_mod( 'digital_agency_lite_blog_pagination_hide_show',true) != '') { ?>
                        <div class="navigation">
                          <?php digital_agency_lite_blog_posts_pagination(); ?>
