<?php
/**
 * VIP Business Customizer Custom Controls
 *
 */
...
/**
	 ...
	 */
	class Vip_Business_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_image_radio_button';
	 ...
	 */
	class Vip_Business_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_simple_notice';
	 ...
	 */
	class Vip_Business_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_toggle_switch';
	 ...
	 */
	class Vip_Business_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_dropdown_posts';
					...
					<?php
						if( !empty( $this->posts ) ) {
							foreach ( $this->posts as $post ) {
								...
								if ( empty( $title ) ) {
									$title = sprintf( esc_html__( 'ID: %s No Title', 'vip-business' ), $post->ID );
								}
	 ...
	 */
	class Vip_Business_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_dropdown_select2';
	 ...
	 *
	 */
	class Vip_Business_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'vip_business_vip-business-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="vip_business_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	class Vip_Business_Note_Control extends WP_Customize_Control {
		public $type = 'vip_business_description';
	 ...
	 */
	if ( ! function_exists( 'vip_business_switch_sanitization' ) ) {
		function vip_business_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'vip_business_radio_sanitization' ) ) {
		function vip_business_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'vip_business_text_sanitization' ) ) {
		function vip_business_text_sanitization( $input ) {
	 ...
	 */
	function vip_business_sanitize_select( $input, $setting ) {
