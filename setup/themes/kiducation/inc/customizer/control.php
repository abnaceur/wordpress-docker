...
class Kiducation_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="kiducation-chosen-select" <?php $this->link(); ?>>
                    <?php
...
Class Kiducation_Customize_Horizontal_Line extends WP_Customize_Control {
    public $type = 'hr';
...
class Kiducation_Multi_Input_Custom_Control extends WP_Customize_Control {
    /**
     * Control type
     *
     * @var string
...
class Kiducation_Note_Control extends WP_Customize_Control {
