...
( function( $, api ) {
	...
	api.controlConstructor['kiducation-repeater-text'] = api.Control.extend({
	    ...
	    // upsell 
    api.sectionConstructor['kiducation-upsell'] = api.Section.extend( {
...
*/
 jQuery(document).ready(function($) {
    // $('#kiducation-img-container li label img').click(function(){    	
    //     $('#kiducation-img-container li').each(function(){
    //         $(this).find('img').removeClass ('kiducation-radio-img-selected') ;
    //     });
    //     $(this).addClass ('kiducation-radio-img-selected') ;
    // }); 
    ...
    $( document ).on( 'click', '.customize_multi_add_field', kiducation_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', kiducation_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', kiducation_customize_multi_remove_field )
    ...
    $('#customize-control-theme_options-layout_options_blog #kiducation-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_blog #kiducation-img-container li').each(function(){
            $(this).find('img').removeClass ('kiducation-radio-img-selected') ;
        });
        $(this).addClass ('kiducation-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_archive #kiducation-img-container li label img').click(function(){       
        $('#customize-control-theme_options-layout_options_archive #kiducation-img-container li').each(function(){
            $(this).find('img').removeClass ('kiducation-radio-img-selected') ;
        });
        $(this).addClass ('kiducation-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_page #kiducation-img-container li label img').click(function(){      
        $('#customize-control-theme_options-layout_options_page #kiducation-img-container li').each(function(){
            $(this).find('img').removeClass ('kiducation-radio-img-selected') ;
        });
        $(this).addClass ('kiducation-radio-img-selected') ;
    });  

    $('#customize-control-theme_options-layout_options_single #kiducation-img-container li label img').click(function(){        
        $('#customize-control-theme_options-layout_options_single #kiducation-img-container li').each(function(){
            $(this).find('img').removeClass ('kiducation-radio-img-selected') ;
        });
        $(this).addClass ('kiducation-radio-img-selected') ;
    });    

    function kiducation_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            kiducation_customize_multi_write( $control );
    }

    function kiducation_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        kiducation_customize_multi_write( $control );
    }

    function kiducation_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function kiducation_customize_multi_write( $element) {
