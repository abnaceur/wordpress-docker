...
<div class='gridme-footer-social-icons'>
    ...
    <?php if ( gridme_get_option('whatsapplink') ) : ?>
            <a href="<?php echo esc_url( gridme_get_option('whatsapplink') ); ?>" target="_blank" rel="nofollow" class="gridme-footer-social-icon-whatsapp" aria-label="<?php esc_attr_e('WhatsApp Button','gridme'); ?>"><i class="fab fa-whatsapp" aria-hidden="true" title="<?php esc_attr_e('WhatsApp','gridme'); ?>"></i></a><?php endif; ?>
