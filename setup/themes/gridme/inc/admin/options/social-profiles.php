...
function gridme_social_profiles($wp_customize) {
    ...
    $wp_customize->add_setting( 'gridme_options[whatsapplink]', array( 'default' => '', 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'esc_url_raw' ) );

    $wp_customize->add_control( 'gridme_whatsapplink_control', array( 'label' => esc_html__( 'WhatsApp URL', 'gridme' ), 'section' => 'gridme_section_social', 'settings' => 'gridme_options[whatsapplink]', 'type' => 'text' ) );
