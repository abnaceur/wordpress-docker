            ...
            <div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
                <div class="eventpress-getting-started-notice clearfix">
                    ...
                    <div class="eventpress-theme-notice-content">
                        ...
                        <p class="plugin-install-notice"><?php echo sprintf(__('Install and activate <strong>Evento</strong> plugin for taking full advantage of all the features this theme has to offer EventPress.', 'eventpress')) ?></p>
