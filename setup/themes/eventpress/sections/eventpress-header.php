					...
					<div class="d-none d-lg-block" id="navbarCollapse">
						<ul class="nav-left">
							<?php if ( ! empty( $eventpress_hdr_btn_lbl ) ) : ?>
								<li><a href="<?php echo esc_url( $eventpress_hdr_btn_link ); ?>" class="hover-effect2 nav-btn"><i class="fa <?php echo esc_attr( $eventpress_hdr_btn_icon ); ?>"></i><?php echo esc_html( $eventpress_hdr_btn_lbl ); ?></a></li>
							<?php endif; ?>	
						</ul>
					</div>
				<?php } ?>
