...
function periar_admin_scripts() {
    wp_enqueue_media();
    wp_enqueue_script( 'periar-jquery-admin-notice-script', get_template_directory_uri() . '/assets/js/jquery-admin.js', array( 'jquery' ), '', true );
    wp_localize_script( 'periar-jquery-admin-notice-script', 'ct_ajax_objects',
