 ...
 * @since 1.0.0
 */
if (!class_exists('AeonMag_Post_Grid')) :
     ...
     * @since 1.0.0
     */
    class AeonMag_Post_Grid extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Grid Posts', 'aeonmag' ),
            'cat' => 0,
            'post-number' => 6,
            'excerpt-length'=> 15,
           );
        ...
        {
            $opts = array(
                'classname' => 'aeonmag-post-grid',
                'description' => esc_html__('Display post in Grid Form. Suitable on Sidebars.', 'aeonmag'),
            );

            parent::__construct('aeonmag-post-grid', esc_html__('AeonMag Post Grid', 'aeonmag'), $opts);
        }
