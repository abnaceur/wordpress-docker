 ...
 * @since 1.0.0
 */
if (!class_exists('AeonMag_Post_Column')) :
     ...
     * @since 1.0.0
     */
    class AeonMag_Post_Column extends WP_Widget
    {

         private function defaults()
        {
            $defaults = array(
            'title' => esc_html__('Post Column', 'aeonmag' ),
            'cat' => 0,
            'post-number' => 5,
            'excerpt-length'=> 15,
           );
        ...
        {
            $opts = array(
                'classname' => 'aeonmag-post-column',
                'description' => esc_html__('Display post in Column Form. Suitable on home page widget.', 'aeonmag'),
            );

            parent::__construct('aeonmag-post-column', esc_html__('AeonMag Post Column', 'aeonmag'), $opts);
        }
                          ...
                          <div class="col-lg-7 col-md-12 col-sm-12 my-auto">
                            <div class="card__post__body">
                                <div class="card__post__content ">
                                    ...
                                    <a href="<?php the_permalink(); ?>" class="readmore mt-2"><?php esc_html_e('Read More', 'aeonmag'); ?></a>
                                </div>
                            </div>
                          </div>
                          <?php } else{ ?>
    ...
    function form($instance)
    {
        ...
        <p class="custom-dropdown-posts">
            <label for="<?php echo esc_attr($this->get_field_name('cat')); ?>">
                <strong><?php esc_html_e('Select Category: ', 'aeonmag'); ?></strong>
            </label>
            <?php
            $cat_args = array(
                'orderby' => 'name',
                ...
                'show_option_all' => esc_html__('Show Recent Posts', 'aeonmag')
            );
        ...
        <p>
        <label
        for="<?php echo esc_attr($this->get_field_id('excerpt-length')); ?>"><?php esc_html_e('Excerpt Length', 'aeonmag'); ?></label>
