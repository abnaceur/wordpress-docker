 ...
 *
 * AeonMag post Slider Widget
 *
 * @since 1.0.0
 */
if (!class_exists('AeonMag_Tabbed')) :
     ...
     * @since 1.0.0
     */
    class AeonMag_Tabbed extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title' => esc_html__('Recent Post', 'aeonmag' ),
                'popular_title'=> esc_html__('Popular', 'aeonmag' ),
                'recent_title'=> esc_html__('Recent', 'aeonmag' ),
                'random'=> esc_html__('Random', 'aeonmag' ),
                'post-number' => 5,
           );
            return $defaults;
        }
        ...
        {
            $opts = array(
                'classname' => 'aeonmag-tabbed',
                'description' => esc_html__('It will help to display the popular and Recent Post Via Tabbed. Suitable on Sidebars.', 'aeonmag'),
            );

            parent::__construct('aeonmag-tabbed', esc_html__('AeonMag Tabbed', 'aeonmag'), $opts);
        }
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Widget Title:', 'aeonmag'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('popular_title')); ?>"><?php esc_html_e('Popular Title:', 'aeonmag'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('recent_title')); ?>"><?php esc_html_e('Recent Title:', 'aeonmag'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('random')); ?>"><?php esc_html_e('Commented Title:', 'aeonmag'); ?></label>
            ...
            <p>
                <label
                for="<?php echo esc_attr($this->get_field_id('post-number')); ?>"><?php esc_html_e('Number of Posts to Display:', 'aeonmag'); ?></label>
