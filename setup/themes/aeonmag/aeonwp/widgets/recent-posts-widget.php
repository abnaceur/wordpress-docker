 ...
 *
 * AeonMag Featured Post Widget.
 *
 * @since 1.0.0
 */
if (!class_exists('AeonMag_Recent_Post_Sidebar')) :
     ...
     * @since 1.0.0
     */
    class AeonMag_Recent_Post_Sidebar extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title'    => esc_html__( 'Recent Posts', 'aeonmag' ),
                'cat'     => 0,
                'post-number'=> 5,
        ...
        {
            $opts = array(
                'classname' => 'aeonmag-featured-post-sidebar',
                'description' => esc_html__('Displays Featured Post in Sidebars. Place it in Sidebar Widget Area.', 'aeonmag'),
            );

            parent::__construct('aeonmag-featured-post-sidebar', esc_html__('AeonMag Recent Post Sidebar', 'aeonmag'), $opts);
        }
