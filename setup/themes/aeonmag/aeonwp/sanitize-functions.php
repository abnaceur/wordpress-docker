 ...
 */
function aeonmag_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function aeonmag_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function aeonmag_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('aeonmag_sanitize_number')) :
    function aeonmag_sanitize_number($input)
    {
 ...
 *
 */
if ( !function_exists('aeonmag_sanitize_image') ) :
	function aeonmag_sanitize_image( $image, $setting ) {
		/*
