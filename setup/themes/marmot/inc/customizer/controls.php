        ...
        switch ($this->type) { // Escape non value from set Customize::setDefauls
            ...
            case 'pro':
                ...
                <label>
                    ...
                    echo '<span class="description customize-control-description">' . sprintf(esc_html(_x('This contol is available only with PRO license. %1$sLearn more%2$s', 'settings', 'marmot')), '<a href="' . esc_url(admin_url('admin.php?page=marmot#marmot-enhancer-pro')) . '" target="_blank">', '</a>') . '</span>';
                    ?>
                </label>
                <?php
                break;
