...
if ( ! function_exists( 'milton_lite_get_pages' ) ) :
/**
 ...
 */
function milton_lite_get_pages() {

    $choices = array( 0 );

    // Default
    $choices = array( 'none' => esc_html__( 'None', 'milton-lite' ) );
    ...
    return apply_filters( 'milton_lite_get_pages', $choices );
}
endif;

if ( ! function_exists( 'milton_lite_sanitize_pages' ) ) :
/**
 ...
 */
function milton_lite_sanitize_pages( $value ) {
...
if ( ! function_exists( 'milton_lite_get_categories' ) ) :
/**
 ...
 */
function milton_lite_get_categories() {
    ...
    return apply_filters( 'milton_lite_get_categories', $choices );
}
endif;

if ( ! function_exists( 'milton_lite_sanitize_categories' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function milton_lite_sanitize_categories( $value ) {

    $choices = milton_lite_get_categories();
    $valid   = array_keys( $choices );
...
if ( ! function_exists( 'milton_lite_get_tags' ) ) :
/**
...
function milton_lite_get_tags() {
    ...
    return apply_filters( 'milton_lite_get_tags', $choices );
}
endif;

if ( ! function_exists( 'milton_lite_sanitize_tags' ) ) :
/**
 * Sanitize a value from a list of allowed values.
 *
 * @since 1.0.0.
 ...
 * @return mixed                The sanitized value.
 */
function milton_lite_sanitize_tags( $value ) {

    $choices = milton_lite_get_tags();
    $valid   = array_keys( $choices );
