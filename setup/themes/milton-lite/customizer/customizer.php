    ...
    class ACADEMIATHEMES_Customizer {
        ...
        private function get_panels() {
            return apply_filters( 'academiathemes_customizer_panels', array(
                'general'      => array( 'title' => esc_html__( 'Theme Settings', 'milton-lite' ), 'priority' => 4000 ),
                'color-scheme' => array( 'title' => esc_html__( 'Theme Colors', 'milton-lite' ), 'priority' => 5000 ),
            ) );
        }
...
// Extra styles
function milton_lite_customizer_stylesheet() {
    
    // Stylesheet
    wp_enqueue_style( 'milton-customizer-css', get_template_directory_uri().'/academia-admin/css/customizer-styles.css', NULL, NULL, 'all' );
    
}

add_action( 'customize_controls_print_styles', 'milton_lite_customizer_stylesheet' );
 ...
 */
function milton_lite_customize_register( $wp_customize ) {

    // Custom help section
    class Milton_Lite_WP_Help_Customize_Control extends WP_Customize_Control {
        public $type = 'text_help';
        public function render_content() {

            echo '
                <div class="bnt-customizer-help">
                    <a class="bnt-customizer-link bnt-support-link" href="https://www.academiathemes.com/free-wordpress-themes/milton-lite/?utm_source=dashboard&utm_medium=customizer-page&utm_campaign=milton-lite&utm_content=official-theme-page-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-info"></span>
                        '.esc_html__( 'Official Theme Page', 'milton-lite' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://demo.academiathemes.com/?theme=milton-lite&utm_source=dashboard&utm_medium=customizer-page&utm_campaign=milton-lite&utm_content=theme-doc-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-book"></span>
                        '.esc_html__( 'Theme Documentation', 'milton-lite' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-support-link" href="https://wordpress.org/support/theme/milton-lite/" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-sos"></span>
                        '.esc_html__( 'Support Forum', 'milton-lite' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://wordpress.org/support/theme/milton-lite/reviews/" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-heart"></span>
                        '.esc_html__( 'Rate Milton Lite', 'milton-lite' ).'
                    </a>
                    <a class="bnt-customizer-link bnt-rate-link" href="https://www.academiathemes.com/themes/milton/?utm_source=dashboard&utm_medium=customizer-page&utm_campaign=milton-lite&utm_content=upgrade-link" target="_blank" rel="noopener">
                        <span class="dashicons dashicons-superhero"></span>
                        '.esc_html__( 'Upgrade to Milton Pro', 'milton-lite' ).'
                        <span class="customize-action">'.esc_html__( 'The PRO version comes with additional custom widgets, templates, customization options and priority support!', 'milton-lite' ).'</span>
                        <br><span class="button button-primary">'.esc_html__( 'View Milton Pro', 'milton-lite' ).'</span>
                    </a>
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                ...
                'render_callback' => 'milton_lite_customize_partial_blogname',
            )
        );
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                ...
                'render_callback' => 'milton_lite_customize_partial_blogdescription',
            )
        );
        ...
        $wp_customize->selective_refresh->add_partial(
            ...
            array(
                'selector'        => '.site-logo',
                'render_callback' => 'milton_lite_customize_partial_site_logo',
            )
        );

        $wp_customize->add_section( 
            'milton_lite_theme_support', 
            array(
                'title' => esc_html__( 'Theme Help & Support', 'milton-lite' ),
                'priority' => 19,
            ) 
        );
        ...
        $wp_customize->add_control(
            new Milton_Lite_WP_Help_Customize_Control(
            $wp_customize,
            'milton_lite_support', 
                array(
                    'section' => 'milton_lite_theme_support',
                    'type' => 'text_help',
                )
            )
        );
...
add_action( 'customize_register', 'milton_lite_customize_register' );

/**
 * PARTIAL REFRESH FUNCTIONS
 * */
if ( ! function_exists( 'milton_lite_customize_partial_blogname' ) ) {
    /**
     * Render the site title for the selective refresh partial.
     */
    function milton_lite_customize_partial_blogname() {
        bloginfo( 'name' );
    }
}

if ( ! function_exists( 'milton_lite_customize_partial_blogdescription' ) ) {
    /**
     * Render the site description for the selective refresh partial.
     */
    function milton_lite_customize_partial_blogdescription() {
        bloginfo( 'description' );
    }
}

if ( ! function_exists( 'milton_lite_customize_partial_site_logo' ) ) {
    /**
     * Render the site logo for the selective refresh partial.
     *
     * Doing it this way so we don't have issues with `render_callback`'s arguments.
     */
    function milton_lite_customize_partial_site_logo() {
        milton_lite_the_custom_logo();
    }
}