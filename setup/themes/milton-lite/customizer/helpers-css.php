...
if ( ! class_exists( 'academiathemes_CSS' ) ) :
    /**
     ...
     */
    class academiathemes_CSS {

        /**
         * The one instance of academiathemes_CSS.
         *
         * @var   academiathemes_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one academiathemes_CSS instance.
         *
         * @return academiathemes_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'academiathemes_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `academiathemes_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'academiathemes_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'academiathemes_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'academiathemes_get_css' ) ) :
    /**
     * Return the one academiathemes_CSS object.
     *
     * @return academiathemes_CSS    The one academiathemes_CSS object.
     */
    function academiathemes_get_css() {
        return academiathemes_CSS::instance();
    }
endif;

add_action( 'init', 'academiathemes_get_css', 1 );