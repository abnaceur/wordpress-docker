		...
		<div id="site-page-columns" class="clearfix">
			...
			<div id="site-column-main" class="site-column site-column-main">
				...
				<div class="site-column-main-wrapper clearfix">
					...
					<h1 class="page-title"><?php esc_html_e('Search Results for', 'milton-lite');?>: <strong><?php the_search_query(); ?></strong></h1>
					<?php get_search_form(); ?>
					...
					<hr /><div class="entry-content clearfix">
						...
						<p><?php esc_html_e( 'Apologies, but the search query did not return any results.', 'milton-lite' ); ?></p>
						
						<h3><?php esc_html_e( 'Browse Categories', 'milton-lite' ); ?></h3>
						<ul>
							<?php wp_list_categories('title_li=&hierarchical=0&show_count=1'); ?>	
						</ul>
					
						<h3><?php esc_html_e( 'Monthly Archives', 'milton-lite' ); ?></h3>
						<ul>
