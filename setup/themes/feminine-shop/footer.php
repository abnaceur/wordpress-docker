    ...
    <footer role="contentinfo">
        ...
        <div id="footer-2" class="pt-3 pb-3 text-center">
          	<div class="copyright container">
                ...
                <?php if( get_theme_mod( 'feminine_shop_footer_scroll') != '') { ?>
                    <?php $feminine_shop_theme_lay = get_theme_mod( 'feminine_shop_scroll_top_alignment','Right');
                    if($feminine_shop_theme_lay == 'Left'){ ?>
                        <a href="#" class="scrollup left"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'feminine-shop' ); ?></span></a>
                    <?php }else if($feminine_shop_theme_lay == 'Center'){ ?>
                        <a href="#" class="scrollup center"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'feminine-shop' ); ?></span></a>
                    <?php }else{ ?>
                        <a href="#" class="scrollup"><i class="fas fa-long-arrow-alt-up p-3"></i><span class="screen-reader-text"><?php esc_html_e( 'Scroll Up', 'feminine-shop' ); ?></span></a>
                    <?php }?>
                <?php }?>
          	</div>
          	<div class="clear"></div>
