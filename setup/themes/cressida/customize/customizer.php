...
function cressida_customizer_fields( $fields ) {
	...
	$fields[] = array(
		...
		'description' => esc_html__( 'Choose whether to display date, category, and author for posts in the blog feed. This applies to all blog feeds on all pages, including the front page.', 'cressida' ),
		'section'     => 'cressida_section_blog_feed',
		'priority'    => 2,
    ...
    $fields[] = array(
		'type'        => 'toggle',
		'settings'    => 'cressida_blog_feed_author_show',
		'label'       => esc_html__( 'Show Author?', 'cressida' ),
		'section'     => 'cressida_section_blog_feed',
		'priority'    => 5,
		'default'     => $cressida_defaults['cressida_blog_feed_author_show'],
		'active_callback'  => array( array(
			'setting'  => 'cressida_blog_feed_meta_show',
			'operator' => '==',
			'value'    => 1
