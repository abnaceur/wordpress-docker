					...
					<div class="kata-post-content">
						...
						<?php if ( has_tag() ) : ?>
							<div class="kata-post-tags">
								<span><?php esc_html__( 'Tags : ', 'kata-business' ); ?></span> <?php Kata_Template_Tags::post_tags(); ?>
							</div>
						<?php endif; ?>
						<div class="kata-post-social-share">
							<span class="kata-post-social-share-title"><?php esc_html__( 'Share : ', 'kata-business' ); ?></span>
