...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'kata-business' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'kata-business' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'kata-business' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'kata-business' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'kata-business' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'kata-business' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'kata-business' ); ?>',
} );
#>
