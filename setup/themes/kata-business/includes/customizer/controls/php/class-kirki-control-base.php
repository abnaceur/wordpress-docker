	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__( 'No File Selected', 'kata-business' ),
				'remove'               => esc_html__( 'Remove', 'kata-business' ),
				'default'              => esc_html__( 'Default', 'kata-business' ),
				'selectFile'           => esc_html__( 'Select File', 'kata-business' ),
				'standardFonts'        => esc_html__( 'Standard Fonts', 'kata-business' ),
				'googleFonts'          => esc_html__( 'Google Fonts', 'kata-business' ),
				'defaultCSSValues'     => esc_html__( 'CSS Defaults', 'kata-business' ),
				'defaultBrowserFamily' => esc_html__( 'Default Browser Font-Family', 'kata-business' ),
			)
		);
