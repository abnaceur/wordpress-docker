	...
	class Kata_Theme_Options {
		...
		public function enqueue_styles() {
			if ( 'customize' === self::current_screen() ) {
				wp_enqueue_style( 'kata-customizer', Kata::$assets . '/customizer.css', array(), Kata::$version );
			}
		}
		...
		public function customizer_inline_style() {
			...
			<div class="kata-customizer-preloader">
				<img src="' . esc_url( kata::$assets ) . 'images/admin/kata-icon.svg" class="kata-customizer-preloader-icon">
			</div>
			<style>
