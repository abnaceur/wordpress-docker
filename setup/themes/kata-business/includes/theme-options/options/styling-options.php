	...
	class Kata_Theme_Options_Styling_Typography extends Kata_Theme_Options {
		...
		public static function set_options() {
			...
			Kirki::add_panel(
				...
				[
					'title'      => esc_html__( 'Styling', 'kata-business' ),
					'icon'       => 'ti-palette',
			...
			Kirki::add_section(
				...
				[
					...
					'title'      => esc_html__( 'Basic Typography', 'kata-business' ),
					'capability' => 'manage_options',
					'priority'   => 8,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Body Typography', 'kata-business' ),
					'description' => esc_html__( 'Controls the typography of body.', 'kata-business' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-business' ),
						'enabel'	=> esc_html__( 'Enabel', 'kata-business' ),
					],
				]
			);
			Kirki::add_field(
				...
				[
					...
					'type'		=> 'select',
					'default'	=> 'select-font',
					'label'		=> esc_html__( 'Font Family', 'kata-business' ),
			...
			Kirki::add_field(
				...
				[
					...
					'section'	=> 'kata_body_typography_section',
					'type'		=> 'dimensions',
					'label'		=> esc_html__( 'Font Properties', 'kata-business' ),
					'default'	=> [
						'font-size'			=> '15px',
						'font-weight'		=> '400',
						'letter-spacing'	=> '0px',
			...
			Kirki::add_field(
				...
				[
					...
					'section'  => 'kata_body_typography_section',
					'type'     => 'color',
					'label'    => esc_html__('Color', 'kata-business'),
					'default'  => '',
					'choices'  => [
						'alpha' => true,
					],
			...
			Kirki::add_section(
				...
				[
					'panel'      => 'kata_styling_and_typography_panel',
					'title'      => esc_html__( 'Headings Typography', 'kata-business' ),
					'capability' => 'manage_options',
					'priority'   => 9,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Headings Typography', 'kata-business' ),
					'description' => esc_html__( 'Controls the typography of H1-H6.', 'kata-business' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-business' ),
			...
			Kirki::add_section(
				...
				[
					'panel'      => 'kata_styling_and_typography_panel',
					'title'      => esc_html__( 'Nav Menu Typography', 'kata-business' ),
					'capability' => 'manage_options',
					'priority'   => 9,
				]
			);
			Kirki::add_field(
				...
				[
					...
					'label'       => esc_html__( 'Nav Menu Typography', 'kata-business' ),
					'description' => esc_html__( 'Controls the typography of nav menu items.', 'kata-business' ),
					'type'        => 'radio-buttonset',
					'default'     => 'disable',
					'choices'     => [
						'disable'	=> esc_html__( 'Disable', 'kata-business' ),
			...
			Kirki::add_section(
				...
				[
					'title'      => esc_html__('Advanced Styling', 'kata-business'),
					'panel'      => 'kata_styling_and_typography_panel',
			...
			Kirki::add_field(
				...
				[
					...
					'label'    => esc_html__('Primary Color', 'kata-business'),
					'default'  => '',
					'choices'  => [
						'alpha' => true,
					],
			...
			Kirki::add_field(
				...
				[
					...
					'section'	=> 'kata_styling_typography_section',
					'type'		=> 'custom',
					'label'		=> esc_html__( 'To more options please install Kata Plus', 'kata-business' ),
					'default'	=> '
					<a href="' . esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ) . '" target="_blank" class="button customizer-kata-builder-button button-large">
						<span class="elementor-switch-mode-off">' . esc_html__( 'Plugins Installer', 'kata-business' ) . '</span>
					</a>',
				]
			);
		}
