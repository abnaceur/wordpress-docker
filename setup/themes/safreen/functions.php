 ...
 */
 add_action( 'after_switch_theme', 'safreen_populate_with_default_widgets' );

function safreen_populate_with_default_widgets() {
	...
	$active_widgets = get_option( 'sidebars_widgets' );
		...
		if ( empty ( $active_widgets[ $safreen_sidebars['sidebar-serviceblock'] ] ) ) {

      $counter = 1;

		$active_widgets['sidebar-serviceblock'][] = 'ctup-ads-servicewidget-'. $counter ;


			$safreen_serviceblock_content[ $counter ] = array(
        'page' => 'sample-page',
        'link_name'=> esc_html__('High Quality','safreen'),
			);

		update_option( 'widget_ctup-ads-servicewidget', $safreen_serviceblock_content );
    ...
    $counter++;
		...
		$safreen_serviceblock_content[ $counter ] = array(
			'page' => 'sample-page',
			'link_name'=> esc_html__('Modern Design','safreen'),
		);
	...
	$safreen_serviceblock_content[ $counter ] = array(
		'page' => 'sample-page',
		'link_name'=> esc_html__('Read More','safreen'),
	);
