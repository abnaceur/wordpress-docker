...
*/
if( ! class_exists( 'Gutenbiz_Mag_Excerpt' ) ):

class Gutenbiz_Mag_Excerpt{
    ...
    */
    ...
    /**
    * So you can call: gutenbiz_mag_excerpt( 'short' );
    *
    * @since  Suit Mag 1.0.0
    * @access protected
    * @var    array
...
/**
* Call to Gutenbiz_Mag_Excerpt
*
* @since  1.0.0
* @uses   Gutenbiz_Mag_Excerpt:::get_instance()->excerpt()
* @param  int $length
* @return void
*/
if( ! function_exists( 'gutenbiz_mag_excerpt' ) ):

    function gutenbiz_mag_excerpt( $length = 55, $echo = true, $more = '', $page_id = false ) {
        $length = apply_filters( 'gutenbiz_mag_custom_excerpt_length', $length );
        return Gutenbiz_Mag_Excerpt::get_instance()->excerpt( $length, $echo, $more, $page_id );
    }
endif;