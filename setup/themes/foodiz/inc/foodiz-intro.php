		...
		<div class="container pl-0 pr-0">
			<div class="row astral-pro-box">
				<div class="col-md-5 pl-0 pr-0">
					<img class="pro-image" src="<?php echo esc_url(get_template_directory_uri()) .'/images/home1.png' ?>">
				</div>
				<div class="col-md-7 ">
					<div class="feature-box">
						<div class="row">
							...
							<div class="col-md-6">
								<div class="imp-link">
									<a style="text-decoration: none;" target="_blank" href="https://mywebapp.in/foodiz-premium/">
										<div class="price-box">
											<h2 class="offer-title1">
												Limited Offer 
											</h2>
											<h3 style="font-size: 20px;color: #000;">Coupon Code OFFER07D</h3>
											<h3 style="color: #000;"><strike>$22</strike> $15 </h3>
										</div>
									</a>

									<ul class="foodiz-btn">
										<li><a target="_blank" class="detail-link" href="https://mywebapp.in/foodiz-premium/">
											View Detail
										</a></li>
										<li><a target="_blank" class="demo-link" href="http://demo.mywebapp.in/foodiz-premium/">
											View Demo
										</a></li>
									</ul>
								</div>
			...
			<div class="row intro-section">
				...
				<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						...
						<a style="background: #ffc107;color: #000;font-weight: 700;" class="nav-item nav-link" id="nav-pro" data-toggle="tab" href="#nav-pro-free" role="tab" aria-controls="nav-support" aria-selected="true"><?php esc_html_e('Free Vs Pro','foodiz'); ?></a>	
				...
				<div class="tab-content py-3 px-3" id="nav-tabContent">
					...
					<!-- plugin -->
					<div class="tab-pane fade show " id="nav-plugin" role="tabpanel" aria-labelledby="nav-plugin-tab">
					...
					<!-- free vs pro -->
					<div class="tab-pane fade show active" id="nav-pro-free" role="tabpanel" aria-labelledby="nav-support-tab">
						<div class="info-box1">
							<div class="container">
					            <div class="row justify-content-center">
					                <table class="pro-feature" border="1">
					                    <tr><th>FEATURES</th><th>Foodiz Free</th><th>Foodiz Premium</th></tr>
					                    <tr>
