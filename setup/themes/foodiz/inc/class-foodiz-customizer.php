...
class foodiz_Customizer {
    ...
    function foodiz_customize_register(WP_Customize_Manager $wp_customize) {     
        ...
        $wp_customize->add_setting('foodiz_scrolltop_show', array(
            'type' => 'theme_mod',
            'default' => '1',
            'sanitize_callback' => 'foodiz_sanitize_checkbox',
            'capability' => 'edit_theme_options',
        ...
        $wp_customize->add_control('foodiz_scrolltop_show', array(
            'label' => __('Enable scroll to top on Page', 'foodiz'),
            'type' => 'checkbox',
            'section' => 'foodiz_frontpage',
            'settings' => 'foodiz_scrolltop_show',
        ));
        ...
        $wp_customize->add_setting('foodiz_footer_show', array(
            'type' => 'theme_mod',
            'default' => '1',
            'sanitize_callback' => 'foodiz_sanitize_checkbox',
            'capability' => 'edit_theme_options',
        ...
        $wp_customize->add_control('foodiz_footer_show', array(
            'label' => __('Footer Widget Area On/Off', 'foodiz'),
            'type' => 'checkbox',
            'section' => 'foodiz_footer',
            'settings' => 'foodiz_footer_show',
        ));
        ...
        //color
        $wp_customize->add_section( 'foodiz_color', array(
            'title'      => __( 'Color Settings', 'foodiz' ),
            'panel'      => 'foodiz_theme_option',
            'capability' => 'edit_theme_options',
            'priority'   => 35,
        ) );
        ...
        'label'      => __( 'Footer Background Color', 'foodiz' ),
        'section'    => 'foodiz_color',
        ...
        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 
        'header_color', array(
        'label'      => __( 'Header Background Color', 'foodiz' ),
        'section'    => 'foodiz_color',
        ...
        $wp_customize->add_setting('foodiz_logo_font_size', array(
        'type' => 'theme_mod',
        'sanitize_callback'=>'wp_filter_nohtml_kses',
        'capability'=>'edit_theme_options'
        ));

        $wp_customize->add_control('foodiz_logo_font_size', array(
        'label' => __('Select logo font size', 'foodiz'),
        'type' => 'number',
        'section' => 'foodiz_typography',
        'settings' => 'foodiz_logo_font_size'
        ));
        ...
        'label' => __('Select menu font size', 'foodiz'),
        'type' => 'number',
        'section' => 'foodiz_typography',
