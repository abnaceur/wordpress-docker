...
<style>
    .foodiz-notice {
        ...
        background: linear-gradient(to right, #3525e0, #dc2457);
    }
    .purchase-btn {
	    text-align: center;
	    background: #6030f5;
	...
	.foodiz-notice h3, .foodiz-notice p {
	    color: #fff;
	}
	.purchase-btn:hover {
	    color: #000;
   ...
   <div class="notice notice-success my-dismiss-notice is-dismissible foodiz-notice">
   	<div class="row">
   		<div class="col-md-6" style="width: 52%;display: inline-block;">
        ...
        <p style="margin: 2em 0;"><?php _e(' Are you are enjoying Foodiz? We would love to hear your feedback. Big thanks in advance.','foodiz'); ?> 
        </p>

        <a style="text-decoration: none;padding: 5px 10px;background: #ffb606;color: #fff;
    font-size: 16px;font-weight: 500;" target="_blank" href="https://wordpress.org/support/theme/foodiz/reviews/#new-post"> <?php _e('Submit a review','foodiz'); ?> </a>
                
        <a style="margin-left: 18px;text-decoration: none;padding: 5px 10px;background: #ffb606;color: #fff; font-size: 16px;font-weight: 500;" target="_blank" href="https://wordpress.org/support/theme/foodiz/" > <?php _e('Any help?','foodiz'); ?> </a>

        <a style="margin-left: 18px;text-decoration: none;padding: 5px 10px;background: #ffb606;color: #fff;font-size: 16px;font-weight: 500;" target="_blank" href="<?php echo admin_url('/themes.php?page=foodiz'); ?>" > <?php _e('View Demo','foodiz'); ?> </a>
    	</div>

    <div class="col-md-6 text-center" style="width: 40%;display: inline-block;background: #ffb606;border: 2px dashed #fff;padding: 10px;">
        <h1 class="blink" style="text-align:center;color: #000;font-weight: 500;padding: 5px 10px 0;margin-bottom: 0;"> Foodiz Premium </h1>
        <h3 style="text-align: center;color: #000;">Use Coupon Code - <span style="text-decoration: underline;">OFFER07D</span> <sub style="font-size: 11px;">Limited Offer</sub></h3>
        <h3 style="color: #000;font-size: 22px;margin-bottom: 30px;text-align: center;"><strike>$22</strike> $15 </h3>
        <a target="_blank" class="purchase-btn" style="margin-right: 10px;" href="http://demo.mywebapp.in/foodiz-premium/">View Demo</a>
        <a target="_blank" class="purchase-btn" style="margin-right: 10px;" href="https://mywebapp.in/foodiz-premium/">Purchase Now</a>
    </div>
</div>
...
add_filter( 'woocommerce_product_single_add_to_cart_text', 'foodiz_woocommerce_custom_single_add_to_cart_text' ); 
function foodiz_woocommerce_custom_single_add_to_cart_text() {
    return __( 'Order Now', 'foodiz' ); 
}

// To change add to cart text on product archives(Collection) page
add_filter( 'woocommerce_product_add_to_cart_text', 'foodiz_woocommerce_custom_product_add_to_cart_text' );  
function foodiz_woocommerce_custom_product_add_to_cart_text() {
    return __( 'Order Now', 'foodiz' );
}