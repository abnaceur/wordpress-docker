...
<body <?php body_class('at-sticky-sidebar');?>>
    ...
    <!-- Header Styles -->
    <?php
        get_template_part( 'inc/header-menu/content',esc_html(get_theme_mod('cr_header_menu_style','style1')));
    ?>
                                            ...
                                            <div class="slide-bg-section">
                                                <div class="slide-bg-text">
                                                    <h1 class="<?php echo esc_attr(get_theme_mod( 'cr_home_text_position','center' )); ?>">
                                                        <?php
                                                            $home_heading_text=esc_html(get_theme_mod( 'cr_home_heading_text'));
                                                    ...
                                                    <p class="<?php echo esc_attr(get_theme_mod( 'cr_home_text_position','center' )); ?>"><?php echo esc_html(get_theme_mod( 'cr_home_subheading_text', get_bloginfo( 'description', 'display' ))); ?></p>                                                    
                                                    <div class="slide-buttons <?php echo esc_attr(get_theme_mod( 'cr_home_text_position','center' )); ?>">    
                                                        <?php
                                                            $home_button_text = esc_html(get_theme_mod( 'cr_home_button_text' ));
                                                            if(!empty($home_button_text)) {
                                                                ?>
                                                                    <div class="read-more first">
                                                                        <a class="btn" href="<?php echo esc_url(get_theme_mod( 'cr_home_button_url' ));?>"><?php echo esc_html(get_theme_mod( 'cr_home_button_text' ));?> 
                                                                        </a>
                                                                    </div>
                                                                <?php
                                                            }
                                                            $home_button2_text = esc_html(get_theme_mod( 'cr_home_button2_text' ));
                                                            if(!empty($home_button2_text)) {
                                                                ?>
                                                                    <div class="read-more">
                                                                        <a class="btn" href="<?php echo esc_url(get_theme_mod( 'cr_home_button2_url' ));?>"><?php echo esc_html(get_theme_mod( 'cr_home_button2_text' ));?> 
                                                                        </a>
                                                                    </div>
                                                                <?php                                                 
                                                            }
