...
class CraterFree_Footer_Social_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__( 'Crater: Footer Social Widget', 'crater-free' ), // Name
			array( 'description' => esc_html__( 'Adds Social icons to footer widgets.', 'crater-free'), ) // Args
		);		     
	}
	...
	public function form( $instance ) {
	    ...
	    ?>     	  	    	
		    <p>
		        <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php esc_html_e('Title:','crater-free'); ?></label>
