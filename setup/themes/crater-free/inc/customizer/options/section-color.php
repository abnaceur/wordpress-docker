...
function crater_free_customizer_color_register( $wp_customize ) {
    ...
    CraterFree_Kirki::add_panel( 'crater_free_colors_panel', array(
        'title'          => esc_html__( 'Color Settings', 'crater-free' ),
        'priority'       => 25,
    ) );
    ...
    CraterFree_Kirki::add_section( 'crater_free_general_color_settings', array(
        ...
        'title'          => esc_html__( 'Header', 'crater-free' ),
    ) );
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Header Background:', 'crater-free' ),
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Top Menu:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#000',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        'type'     => 'color',
        'settings' => 'cr_top_active_menu_a_color',
        ...
        'output' => array(
            array(
                'element'  => ' #crater-main-menu-wrapper .nav>li.active a',
                'property' => 'color',
            ),
        ),
    ] );

    // Top menu active bg color
    CraterFree_Kirki::add_field( 'crater-free', [
        'type'     => 'color-alpha',
        'settings' => 'cr_top_active_menu_color',
        'label'    => esc_html__( 'Top Menu Active Background:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#e02f2f',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Top Menu Active Underline:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#b91313',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Dropdown background:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#fff',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Toggle button color:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#555',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Home Background Section content color:', 'crater-free' ),
        'section'  => 'crater_free_general_color_settings',
        'default'  => '#fff',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_section( 'crater_free_blog_color_settings', array(
        'panel'          => 'crater_free_colors_panel',
        'title'          => esc_html__( 'Blog', 'crater-free' ),
    ) );
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Sidebar Items Left Border:', 'crater-free' ),
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Links:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#444',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Links Hover:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#000',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Headings:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#444',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Headings Hover:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#dd3333',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Buttons:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#fe7237',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Buttons Hover:', 'crater-free' ),
        'section'  => 'crater_free_blog_color_settings',
        'default'  => '#db5218',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_section( 'crater_free_footer_color_settings', array(
        'panel'          => 'crater_free_colors_panel',
        'title'          => esc_html__( 'Footer', 'crater-free' ),
    ) );
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Footer background:', 'crater-free' ),
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Footer Content:', 'crater-free' ),
        'section'  => 'crater_free_footer_color_settings',
        'default'  => '#b3b3b3',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Footer Links:', 'crater-free' ),
        'section'  => 'crater_free_footer_color_settings',
        'default'  => '#b3b3b3',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        ...
        'label'    => esc_html__( 'Footer Links Hover:', 'crater-free' ),
        'section'  => 'crater_free_footer_color_settings',
        'default'  => '#000',
        'transport'  => 'auto',
        'output' => array(
    ...
    CraterFree_Kirki::add_section( 'crater_free_sticky_header_color_settings', array(
        'panel'          => 'crater_free_colors_panel',
        'title'          => esc_html__( 'Sticky Header', 'crater-free' ),
    ) );
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        'type'     => 'color',
        'settings' => 'cr_sticky_top_active_menu_a_color',
        'label'    => esc_html__( 'Top Menu Active:', 'crater-free' ),
        'section'  => 'crater_free_sticky_header_color_settings',
        'default'  => '#555',
        'transport'  => 'auto',
        'output' => array(
            array(
                'element'  => 'header#home-inner.fixed #crater-main-menu-wrapper .nav>li.active a',
                'property' => 'color',
            ),
            array(
                'element'  => 'header#page-inner.fixed #crater-main-menu-wrapper .nav>li.active a',
                'property' => 'color',
            ),
        ),
    ] );

    // Top menu active color background
    CraterFree_Kirki::add_field( 'crater-free', [
        'type'     => 'color-alpha',
    ...
    CraterFree_Kirki::add_section( 'crater_free_inner_pages_color_settings', array(
        'panel'          => 'crater_free_colors_panel',
        'title'          => esc_html__( 'Inner Pages Header', 'crater-free' ),
    ) );
    ...
    CraterFree_Kirki::add_field( 'crater-free', [
        'type'     => 'color',
        'settings' => 'cr_ip_top_active_menu_a_color',
        'label'    => esc_html__( 'Top Menu Active:', 'crater-free' ),
        'section'  => 'crater_free_inner_pages_color_settings',
        'default'  => '#555',
        'transport'  => 'auto',
        'output' => array(
            array(
                'element'  => 'header#page-inner #crater-main-menu-wrapper .nav>li.active a',
                'property' => 'color',
            ),
        ),
    ] );
