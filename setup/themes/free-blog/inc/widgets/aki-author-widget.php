...
if (!class_exists('Free_Blog_Author_Widget')) :
     ...
     */
    class Free_Blog_Author_Widget extends WP_Widget
    {
        ...
        {
            $opts = array(
                'classname' => 'free_blog_widget_author',
                'description' => esc_html__('Display Author Profile.', 'free-blog'),
            );
            parent::__construct('free-blog-author', esc_html__('Free Blog Author', 'free-blog'), $opts);
        }
            ...
            <div class="author-profile">
                ...
                <div class="profile-wrapper social-menu-wrap">
                    ...
                    <?php if ($author_facebook || $author_twitter || $author_linkedin || $author_instagram || $author_pinterest || $author_youtube || $author_vk || $author_sign) { ?>
                        <ul class="menu author-social-profiles free-blog-social-menu">
                            <?php if ($author_facebook) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_facebook); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('facebook', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_twitter) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_twitter); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('twitter', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_linkedin) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_linkedin); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('linkedin', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_instagram) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_instagram); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('instagram', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_pinterest) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_pinterest); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('pinterest', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_youtube) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_youtube); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('youtube', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                            ...
                            <?php if ($author_vk) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_vk); ?>" target="_blank"><span
                                            class="screen-reader-text"><?php esc_html_e('vk', 'free-blog'); ?></span></a>
                                </li>
                            <?php } ?>
                    ...
                    if (isset($author_sign) && !empty($author_sign)) {
                        ?>
                        <p class="author-sign"><?php if (isset($author_sign) && !empty($author_sign)) {
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'free-blog'); ?></strong></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'free-blog'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_image'); ?>">
                    <?php _e('Select Image: Recommended size 250*250', 'free-blog'); ?>
                </label>
                <br/>
                <?php
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'free-blog') ?>"/>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_facebook')); ?>">
                    <?php esc_html_e('Facebook:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_twitter')); ?>">
                    <?php esc_html_e('Twitter:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_linkedin')); ?>">
                    <?php esc_html_e('LinkedIn:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_instagram')); ?>">
                    <?php esc_html_e('Instagram:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_pinterest')); ?>">
                    <?php esc_html_e('Pinterest:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_name('author_youtube')); ?>">
                    <?php esc_html_e('Youtube:', 'free-blog'); ?>
                </label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_sign')); ?>"><strong><?php esc_html_e('Author Sign Text:', 'free-blog'); ?></strong></label>
...
add_action('admin_enqueue_scripts', 'free_blog_widgets_backend_enqueue');
function free_blog_widgets_backend_enqueue()
{
    wp_register_script('free-blog-custom-widgets', get_template_directory_uri() . '/assets/js/widgets.js', array('jquery'), true);
    $translation = array(
        'btn_text' => esc_html__( 'Processing...', 'free-blog' ),
        'nonce'    => wp_create_nonce( 'free_blog_demo_import_nonce' ),
        'noncen'    => 'free_blog_demo_import_nonce',
        'adminurl'    => admin_url(),
    );
    wp_localize_script( 'free-blog-custom-widgets', 'free_blog_adi_install', $translation );
    wp_enqueue_media();
    wp_enqueue_script('free-blog-custom-widgets');
}