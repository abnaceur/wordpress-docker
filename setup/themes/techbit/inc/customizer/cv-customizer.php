...
function techbit_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'title_tagline' )->panel        = 'techbit_general_panel';
    $wp_customize->get_section( 'title_tagline' )->priority     = '5';
    $wp_customize->get_section( 'colors' )->panel               = 'techbit_general_panel';
    $wp_customize->get_section( 'colors' )->priority            = '10';
    $wp_customize->get_section( 'static_front_page' )->panel    = 'techbit_general_panel';
    $wp_customize->get_section( 'static_front_page' )->priority = '20';

    $wp_customize->get_section( 'header_image' )->panel        = 'techbit_header_panel';
    $wp_customize->get_section( 'header_image' )->priority     = '5';
    $wp_customize->get_section( 'header_image' )->title  	   = __( 'Innerpage Header Image', 'techbit' );
 ...
 */
  ...
  */
 function techbit_kirki_configuration() {
 	return array(
 		'url_path' => get_template_directory_uri() . '/inc/kirki/',
 	);
 }

 add_filter( 'kirki/config', 'techbit_kirki_configuration' );


/**
 * techbit Kirki Config
 */
Kirki::add_config( 'techbit_config', array(
