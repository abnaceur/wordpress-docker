...
<button class="gridhub-scroll-top" title="<?php esc_attr_e('Scroll to Top','gridhub'); ?>"><i class="fas fa-arrow-up" aria-hidden="true"></i><span class="gridhub-sr-only"><?php esc_html_e('Scroll to Top', 'gridhub'); ?></span></button>
