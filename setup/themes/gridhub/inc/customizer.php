...
function gridhub_register_theme_customizer( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'gridhub_options[whatsapplink]', array( 'default' => '', 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'esc_url_raw' ) );

    $wp_customize->add_control( 'gridhub_whatsapplink_control', array( 'label' => esc_html__( 'WhatsApp URL', 'gridhub' ), 'section' => 'gridhub_section_social', 'settings' => 'gridhub_options[whatsapplink]', 'type' => 'text' ) );
