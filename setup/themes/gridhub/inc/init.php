...
<div class='gridhub-social-icons'>
    ...
    <?php if ( gridhub_get_option('whatsapplink') ) : ?>
            <a href="<?php echo esc_url( gridhub_get_option('whatsapplink') ); ?>" target="_blank" rel="nofollow" class="gridhub-social-icon-whatsapp" aria-label="<?php esc_attr_e('WhatsApp Button','gridhub'); ?>"><i class="fab fa-whatsapp" aria-hidden="true" title="<?php esc_attr_e('WhatsApp','gridhub'); ?>"></i></a><?php endif; ?>
    ...
    if ( !(gridhub_get_option('hide_post_categories_home')) || !(gridhub_get_option('hide_post_tags_home')) || !(gridhub_get_option('hide_comments_link_home')) ) { ?>
        ...
        if ( !(gridhub_get_option('hide_comments_link_home')) ) {
            if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) {
                ...
                comments_popup_link( sprintf( wp_kses( /* translators: %s: post title */ __( 'Leave a Comment<span class="gridhub-sr-only"> on %s</span>', 'gridhub' ), array( 'span' => array( 'class' => array(), ), ) ), wp_kses_post( get_the_title() ) ) );
                echo '&nbsp;&nbsp;&nbsp;</span>';
            }
        }
        if ( !(gridhub_get_option('hide_post_categories_home')) ) {
            if ( 'post' == get_post_type() ) {
                ...
                if ( $categories_list ) {
                    /* translators: 1: list of categories. */ printf( '<span class="gridhub-grid-post-bottom-cat-links gridhub-grid-post-bottom-meta"><i class="fas fa-folder-open" aria-hidden="true"></i>&nbsp;' . __( '<span class="gridhub-sr-only">Posted in </span>%1$s', 'gridhub' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                }
            }
        }
        if ( !(gridhub_get_option('hide_post_tags_home')) ) {
            if ( 'post' == get_post_type() ) {
                ...
                $tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'gridhub' ) );
                if ( $tags_list ) {
                    /* translators: 1: list of tags. */ printf( '<span class="gridhub-grid-post-bottom-tags-links gridhub-grid-post-bottom-meta"><i class="fas fa-tags" aria-hidden="true"></i>&nbsp;' . __( '<span class="gridhub-sr-only">Tagged </span>%1$s', 'gridhub' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                }
            }
        }
        ?>
...
function gridhub_single_cats() {
    if ( 'post' == get_post_type() ) {
        ...
        if ( $categories_list ) {
            ...
            printf( '<span class="gridhub-entry-meta-single-cats"><i class="far fa-folder-open" aria-hidden="true"></i>&nbsp;' . __( '<span class="gridhub-sr-only">Posted in </span>%1$s', 'gridhub' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        }
    }
}
endif;
...
function gridhub_single_postmeta() { ?>
    ...
    <span class="gridhub-entry-meta-single-comments"><i class="far fa-comments" aria-hidden="true"></i>&nbsp;<?php comments_popup_link( sprintf( wp_kses( /* translators: %s: post title */ __( 'Leave a Comment<span class="gridhub-sr-only"> on %s</span>', 'gridhub' ), array( 'span' => array( 'class' => array(), ), ) ), wp_kses_post( get_the_title() ) ) ); ?></span>
    <?php } ?><?php } ?>
    ...
    <?php if ( !(gridhub_get_option('hide_post_edit')) ) { ?><?php edit_post_link( sprintf( wp_kses( /* translators: %s: Name of current post. Only visible to screen readers */ __( 'Edit<span class="gridhub-sr-only"> %s</span>', 'gridhub' ), array( 'span' => array( 'class' => array(), ), ) ), wp_kses_post( get_the_title() ) ), '<span class="edit-link">&nbsp;&nbsp;<i class="far fa-edit" aria-hidden="true"></i> ', '</span>' ); ?><?php } ?>
    </div>
    </div>
    <?php } ?>
<?php }
