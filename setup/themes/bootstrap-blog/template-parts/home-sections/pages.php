<?php if( get_theme_mod( 'pages_display_option', false ) ) : ?>
  <div class="home-pages">
    <div class="row">
      ...
      <?php $bootstrap_blog_pages = get_theme_mod( 'pages' ); ?>
      <?php if( is_array( $bootstrap_blog_pages ) && ! empty( $bootstrap_blog_pages ) ) : ?>

        <?php foreach( $bootstrap_blog_pages as $value ) : ?>
