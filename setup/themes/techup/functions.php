  ...
  <div class="wrap about-wrap one-pageily-add-css">
    <div>
      ...
      <div class="feature-section three-col">
        ...
        <div class="col">
          <div class="widgets-holder-wrap">
            <h3><?php echo __("Review Theme", "techup" ); ?></h3>
            <p><?php echo __("Nothing motivates us more than feedback, are you are enjoying Techup? We would love to hear what you think!.", "techup" ); ?></p>
            <p><a target="blank" href="<?php echo esc_url('https://wordpress.org/support/theme/techup/reviews/', 'techup'); ?>" class="button button-primary">
              <?php echo __("Submit A Review", "techup" ); ?>
            </a></p>
          </div>
        </div>
         <div class="col">
    ...
    <div class="one-pageily-button-container">
      ...
      <a target="blank" href="<?php echo esc_url('https://testerwp.com/template/logitech/', 'techup'); ?>" class="button button-primary">
        <?php echo __("View Theme Demo", "techup" ); ?>
      </a>
    </div>
