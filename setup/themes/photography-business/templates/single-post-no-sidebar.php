...
<main id="main" class="site-main" role="main">
	...
	<div id="content"  class="page-content">
		...
		<div class="flowid photography-business-single-no-sidebar">
		            ...
		            <div class="wid-100 blog-2-col-inner">
		                ...
		                <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>	
		                	...
		                	<div class="items wid-100 mobwid-100">
	                                	...
	                                	<div class="title-header">
	                                        ...
	                                        <div class="text-center title-content">
		                                        ...
		                                        <span class="dsply-ib mg-left-15 text-center author">
		                                        	<?php esc_html_e('by ', 'photography-business'); ?><?php the_author_posts_link(); ?>
		                                        </span>
					            ...
					            <div class="phography_business_link_pages">
						            <?php wp_link_pages(); ?>
						        </div>
