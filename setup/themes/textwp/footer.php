...
<button class="textwp-scroll-top" title="<?php esc_attr_e('Scroll to Top','textwp'); ?>"><i class="fas fa-arrow-up" aria-hidden="true"></i><span class="textwp-sr-only"><?php esc_html_e('Scroll to Top', 'textwp'); ?></span></button>
