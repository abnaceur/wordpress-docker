...
function textwp_register_theme_customizer( $wp_customize ) {
    ...
    if ( isset( $wp_customize->selective_refresh ) ) {
        $wp_customize->selective_refresh->add_partial( 'blogname', array(
            'selector'        => '.textwp-site-title a',
            'render_callback' => 'textwp_customize_partial_blogname',
        ) );
        $wp_customize->selective_refresh->add_partial( 'blogdescription', array(
            'selector'        => '.textwp-site-description',
            'render_callback' => 'textwp_customize_partial_blogdescription',
        ) );
    }
 ...
 * @return void
 */
function textwp_customize_partial_blogname() {
    bloginfo( 'name' );
}
/**
 ...
 * @return void
 */
function textwp_customize_partial_blogdescription() {
