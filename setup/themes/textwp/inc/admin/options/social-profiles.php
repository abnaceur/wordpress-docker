...
function textwp_header_social_profiles($wp_customize) {
    ...
    $wp_customize->add_setting( 'textwp_options[whatsapp_button]', array( 'default' => '', 'type' => 'option', 'capability' => 'edit_theme_options', 'sanitize_callback' => 'esc_url_raw' ) );

    $wp_customize->add_control( 'textwp_whatsapp_button_control', array( 'label' => esc_html__( 'WhatsApp URL', 'textwp' ), 'section' => 'textwp_section_social_header', 'settings' => 'textwp_options[whatsapp_button]', 'type' => 'text' ) );
