...
<div class='textwp-featured-posts-area textwp-featured-posts-area-bottom textwp-textwp-clearfix'>
<?php if ( is_front_page() && is_home() && !is_paged() ) { ?>
...
function textwp_post_bottom_widgets() {
    if ( is_active_sidebar( 'textwp-single-post-bottom-widgets' ) ) : ?>
        <div class="textwp-featured-posts-area textwp-textwp-clearfix">
