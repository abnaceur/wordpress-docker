...
<div class="textwp-header-social-icons textwp-textwp-clearfix">
    ...
    <?php if ( textwp_get_option('whatsapp_button') ) : ?>
            <a href="<?php echo esc_url( textwp_get_option('whatsapp_button') ); ?>" target="_blank" rel="nofollow" class="textwp-social-icon-whatsapp" aria-label="<?php esc_attr_e('WhatsApp Button','textwp'); ?>"><i class="fab fa-whatsapp" aria-hidden="true" title="<?php esc_attr_e('WhatsApp','textwp'); ?>"></i></a><?php endif; ?>
