...
<div class="listarticle">
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="entry-summary">
           	<?php the_excerpt(); ?>
            <div class="pagemore" >
                <a href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','smallbiz-startup'); ?></a>
            </div>
        </div>
        <?php else : ?>
        <div class="entry-content">
            <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'smallbiz-startup' ) ); ?>
            <?php
                wp_link_pages( array(
                    'before' => '<div class="page-links">' . __( 'Pages:', 'smallbiz-startup' ),
                    'after'  => '</div>',
                ) );
            ?>
        </div>
