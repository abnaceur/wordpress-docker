 ...
 */
function gt_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function gt_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function gt_sanitize_email( $email, $setting ) {
 ...
 */
function gt_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function gt_sanitize_html( $html ) {
 ...
 */
function gt_sanitize_image( $image, $setting ) {
 ...
 */
function gt_sanitize_nohtml( $nohtml ) {
 ...
 */
function gt_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function gt_sanitize_number_range( $number, $setting ) {
 ...
 */
function gt_sanitize_select( $input, $setting ) {
