...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php deep_modern_business_post_thumbnail(); ?>
	...
	<div class="entry-content">
		...
		if ( is_single() ) {
			the_content(
				sprintf(
					wp_kses(
						...
						__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'deep-modern-business' ),
						array(
							'span' => array(
								'class' => array(),
							),
			...
			wp_link_pages(
				array(
					'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'deep-modern-business' ),
					'after'  => '</div>',
				)
			);

			// Display Tags
			$tags = the_tags('<div class="deep-modern-business-tags">'. esc_html__( 'Tags', 'deep-modern-business' ) .': ',', ','</div>');
			...
			?>
			<a class="more-link" href="<?php echo esc_url( get_permalink() ); ?>"><?php echo esc_html__( 'Continue Reading', 'deep-modern-business' ); ?></a>
			<?php
