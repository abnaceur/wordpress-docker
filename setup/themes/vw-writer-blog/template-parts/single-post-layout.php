    ...
    <div class="single-post">
        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' .esc_html(get_theme_mod('vw_writer_blog_single_blog_next_navigation_text','NEXT')) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'vw-writer-blog' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' .esc_html(get_theme_mod('vw_writer_blog_single_blog_prev_navigation_text','PREVIOUS')) . '</span> ' .
