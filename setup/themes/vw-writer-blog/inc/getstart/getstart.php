...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_writer_blog_open_tab(event, 'writer_lite')"><?php esc_html_e( 'Getting Started', 'vw-writer-blog' ); ?></button>		  
				...
				<div class="info-link">
		  		...
		  		<div class="link-customizer">
					...
					<div class="first-row">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-images-alt"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_writer_blog_post_settings') ); ?>" target="_blank"><?php esc_html_e('Post settings','vw-writer-blog'); ?></a>
							</div>
							 <div class="row-box2">
						...
						<div class="row-box">
							<div class="row-box1">
								<span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_writer_blog_left_right') ); ?>" target="_blank"><?php esc_html_e('General Settings','vw-writer-blog'); ?></a>
							</div>
							<div class="row-box2">
