        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-writer-blog' ); ?>">
                </div>
...
function vw_writer_blog_customizer_script() {     
    ...
    wp_enqueue_script( 'vw-writer-blog-customizer-script', esc_url(get_template_directory_uri()).'/js/customizer-scripts.js', array("jquery"),'', true  );
}
