...
class VW_Writer_Blog_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'VW_Writer_Blog_About_Widget',
			__('VW About us', 'vw-writer-blog'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'vw-writer-blog' ), ) 
		);
	}
	...
	?>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','vw-writer-blog'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','vw-writer-blog'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','vw-writer-blog'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','vw-writer-blog'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','vw-writer-blog'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','vw-writer-blog'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function vw_writer_blog_about_custom_load_widget() {
	register_widget( 'VW_Writer_Blog_About_Widget' );
}
add_action( 'widgets_init', 'vw_writer_blog_about_custom_load_widget' );