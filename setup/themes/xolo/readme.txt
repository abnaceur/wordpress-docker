...
Xolo includes support for Infinite Scroll in Jetpack Plugins.

-------------------------------------------------------------------------------------------------
License and Copyrights for Resources used in Xolo WordPress Theme
-------------------------------------------------------------------------------------------------
...
Source: https://github.com/select2/select2/tree/master
...
8) WP Alpha Color Picker 
=================================================================================================
License -   GNU General Public License  (https://github.com/kallookoo/wp-color-picker-alpha/blob/master/LICENSE)
...
=================================================================================================
Screenshot vector & all other Images have been used in images folder, Created by Xolo Software. Also they are GPL Licensed and free to use and free to redistribute further.
