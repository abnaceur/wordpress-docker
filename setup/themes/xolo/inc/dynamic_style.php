    ...
    function xolo_dynamic_style() {
		 ...
		 */
		 ...
		 if($xolo_header_bg_color !== '') { 
			$output_css .="body .header, body[class*='header-'].page .header, .header-four .header {
		 ...
		 *  Breadcrumb Style
		 */
		$output_css   .= xolo_customizer_value( 'breadcrumb_min_height', 'body[class*="header"] .breadcrumb-area div.breadcrumb-content', array( 'min-height' ), array( 75, 75, 75 ), 'px' );
