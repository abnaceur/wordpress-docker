...
if( ! class_exists( 'Isha_Control_Repeater' ) ) {
    ...
    class Isha_Control_Repeater extends WP_Customize_Control {
        ...
        public function repeater_js_template() {
            ...
            <div class="actions">
                <button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_html_e( 'Remove', 'isha' ); ?></button>
        ...
        <# }); #>
        <button type="button" class="button-link repeater-row-remove"><?php esc_html_e( 'Remove', 'isha' ); ?></button>
    </div>
</li>
</script>
<?php
