...
function blogwp_scripts() {
    ...
    $blogwp_primary_menu_active = FALSE;
    if ( !blogwp_get_option('disable_primary_menu') ) {
        $blogwp_primary_menu_active = TRUE;
    }
    ...
    wp_enqueue_script('blogwp-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), NULL, true );
    wp_enqueue_script('blogwp-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), NULL, true );
    ...
    wp_localize_script( 'blogwp-customjs', 'blogwp_ajax_object',
        array(
            ...
            'primary_menu_active' => $blogwp_primary_menu_active,
