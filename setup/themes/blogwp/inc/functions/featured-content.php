...
<div class="blogwp-featured-content-inner clearfix">
    ...
    <div class="blogwp-featured-content-post">
        ...
        <div class="blogwp-featured-content-post-thumbnail">
            <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'blogwp' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="blogwp-featured-content-post-thumbnail-link"><?php the_post_thumbnail('blogwp-mediumh-image', array('class' => 'blogwp-featured-content-post-thumbnail-img', 'title' => get_the_title())); ?></a>
        </div>
        <?php } else { ?>
        <div class="blogwp-featured-content-post-thumbnail">
            <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'blogwp' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="blogwp-featured-content-post-thumbnail-link"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/no-image-5-3.jpg' ); ?>" class="blogwp-featured-content-post-thumbnail-img"/></a>
        </div>
        <?php } ?>
        ...
        if ( 'post' == get_post_type() ) {
            ...
            if ( $categories_list ) {
                ...
                printf( '<div class="blogwp-featured-content-post-categories">' . __( '<span class="screen-reader-text">Posted in </span>%1$s', 'blogwp' ) . '</div>', $categories_list ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped */
            }
        }
        ?>
        ...
        <span class="blogwp-featured-content-post-author blogwp-featured-content-post-meta"><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><span class="screen-reader-text"><?php esc_html_e('Author: ', 'blogwp'); ?></span><?php echo esc_html( get_the_author() ); ?></a></span>
        <span class="blogwp-featured-content-post-date blogwp-featured-content-post-meta"><span class="screen-reader-text"><?php esc_html_e('Published Date: ', 'blogwp'); ?></span><?php echo get_the_date('Y-m-d'); ?></span>
        <?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) { ?><span class="blogwp-featured-content-post-comment blogwp-featured-content-post-meta"><?php comments_popup_link( sprintf( wp_kses( /* translators: %s: post title */ __( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'blogwp' ), array( 'span' => array( 'class' => array(), ), ) ), get_the_title() ) ); ?></span><?php } ?>
        </div>
        </div>
