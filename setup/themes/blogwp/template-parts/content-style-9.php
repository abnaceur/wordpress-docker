...
<div id="post-<?php the_ID(); ?>" class="blogwp-fp09-post blogwp-box">
    ...
    <div class="blogwp-fp09-post-thumbnail">
        <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'blogwp' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="blogwp-fp09-post-thumbnail-link"><?php the_post_thumbnail('blogwp-featured-image', array('class' => 'blogwp-fp09-post-thumbnail-img')); ?></a>
    </div>
    <?php } ?>
    <?php } ?>
