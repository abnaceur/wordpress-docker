...
<div id="post-<?php the_ID(); ?>" class="blogwp-fp05-post blogwp-box">
    ...
    <div class="blogwp-fp05-post-thumbnail">
        <a href="<?php echo esc_url( get_permalink() ); ?>" title="<?php /* translators: %s: post title. */ echo esc_attr( sprintf( __( 'Permanent Link to %s', 'blogwp' ), the_title_attribute( 'echo=0' ) ) ); ?>" class="blogwp-fp05-post-thumbnail-link"><?php the_post_thumbnail('blogwp-medium-image', array('class' => 'blogwp-fp05-post-thumbnail-img')); ?></a>
    </div>
    <?php } ?>
    <?php } ?>
    ...
    <?php if ( !(blogwp_get_option('hide_read_more_button')) ) { ?><div class='blogwp-fp05-post-read-more'><a href="<?php echo esc_url( get_permalink() ); ?>"><span class="blogwp-read-more-text"><?php echo esc_html( blogwp_read_more_text() ); ?><span class="screen-reader-text"> <?php the_title(); ?></span></span></a></div><?php } ?>
