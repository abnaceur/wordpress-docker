...
function blogwp_content_width() {
    $blogwp_content_width = 667;

    if ( is_page_template( array( 'template-full-width-page.php', 'template-full-width-post.php' ) ) ) {
       $blogwp_content_width = 1018;
    }
    ...
    $GLOBALS['content_width'] = apply_filters( 'blogwp_content_width', $blogwp_content_width ); /* phpcs:ignore WPThemeReview.CoreFunctionality.PrefixAllGlobals.NonPrefixedVariableFound */
}
