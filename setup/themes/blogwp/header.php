...
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#blogwp-posts-wrapper"><?php esc_html_e( 'Skip to content', 'blogwp' ); ?></a>

<?php if ( !(blogwp_get_option('disable_primary_menu')) ) { ?>
<div class="blogwp-container blogwp-primary-menu-container clearfix">
<div class="blogwp-primary-menu-container-inside clearfix">
<nav class="blogwp-nav-primary" id="blogwp-primary-navigation" itemscope="itemscope" itemtype="http://schema.org/SiteNavigationElement" role="navigation" aria-label="<?php esc_attr_e( 'Primary Menu', 'blogwp' ); ?>">
<div class="blogwp-outer-wrapper">
<button class="blogwp-primary-responsive-menu-icon" aria-controls="blogwp-menu-primary-navigation" aria-expanded="false"><?php esc_html_e( 'Menu', 'blogwp' ); ?></button>
<?php wp_nav_menu( array( 'theme_location' => 'primary', 'menu_id' => 'blogwp-menu-primary-navigation', 'menu_class' => 'blogwp-primary-nav-menu blogwp-menu-primary', 'fallback_cb' => 'blogwp_fallback_menu', 'container' => '', ) ); ?>
</div>
</nav>
</div>
</div>
...
<div id="blogwp-search-overlay-wrap" class="blogwp-search-overlay">
  <button class="blogwp-search-closebtn" aria-label="<?php esc_attr_e( 'Close Search', 'blogwp' ); ?>" title="<?php esc_attr_e('Close Search','blogwp'); ?>">&#xD7;</button>
