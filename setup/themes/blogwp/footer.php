...
<button class="blogwp-scroll-top" title="<?php esc_attr_e('Scroll to Top','blogwp'); ?>"><span class="fa fa-arrow-up" aria-hidden="true"></span><span class="screen-reader-text"><?php esc_html_e('Scroll to Top', 'blogwp'); ?></span></button>
