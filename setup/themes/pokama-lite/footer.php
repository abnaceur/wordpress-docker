...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info container">
			<p class="footer-text left"><?php printf(esc_html__('%1$s %2$s %3$s  - All Rights Reserved', 'pokama-lite'), '&copy;', esc_attr(date_i18n(__('Y', 'pokama-lite'))), esc_attr(get_bloginfo())); ?></p>
            <p class="footer-text right"><?php printf(esc_html__('%1$s Pokama Lite theme by %2$s', 'pokama-lite'), '', '<a href="' . esc_url('https://zthemes.net/', 'pokama-lite') . '">ZThemes</a>'); ?></p>
		</div><!-- .site-info -->
