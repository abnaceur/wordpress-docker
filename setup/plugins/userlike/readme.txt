...
Tags: userlike, livechat, livehelp, chat, messenger, chat plugin, live support, wordpress live chat, help desk software, help desk, free chat
...
[Userlike](https://www.userlike.com/en/) is a WordPress live chat plugin to chat with your customers via your website, Facebook Messenger, and Telegram. With this plugin you add a chat box at the bottom of your site through which visitors can reach out with questions.
...
Userlike is one of the top rated live chat plugins across platforms like [Capterra](http://www.capterra.com/p/131558/Userlike-Live-Chat/), [G2Crowd](https://www.g2crowd.com/products/userlike/reviews), and [Social Compare](http://socialcompare.com/en/comparison/compare-live-chat-support-software-help). Companies like [BMW, Lufthansa, and Trivago](https://www.userlike.com/en/customers) are already using Userlike to build customer relationships.
...
Learn more about how [Statista](https://userlike.com/en/casestudy/statista), [Cyberport](https://userlike.com/en/casestudy/cyberport), and [Titus](https://userlike.com/en/casestudy/titus) use Userlike’s chat solution to create happy, longterm customer relationships.
...
You can, but we don’t offer a mobile app and we strongly recommend you to offer chat support on a computer only. Firstly, it is easy to miss notifications of incoming chats on your phone. Secondly, mobile connections are often not stable enough to support a proper chat connection. Both result in frustrated customers.
...
1. Live Chat for Website and Mobile Support
2. One hub for all your customer relationships
3. Adjust design to the look and feel of your website
4. Keep track of your key metrics and improve your performance
5. Organize your team by function or language
6. Your cockpit for delivering stunning chat support

== Changelog ==

= 2.1 =
* Update Support Widget
* Add async parameter to all script tags

= 2.0.3 =
* Update youtube video

= 2.0.2 =
* Update readme, increase supported Wordpress version
* Bump plugin version
...
* Update script tag with async parameter to execute asynchronously with the rest of the page

= 1.9 =
* Update tested version and readme
