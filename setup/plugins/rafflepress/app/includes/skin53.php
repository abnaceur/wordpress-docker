...
class RafflePress_Skin extends WP_Upgrader_Skin
{
    ...
    {
        if (! empty($errors)) {
            echo json_encode(array( 'error' => esc_html__('There was an error installing the addon. Please try again.', 'rafflepress') ));
            die;
        }
    }
