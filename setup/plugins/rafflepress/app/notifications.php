 ...
 * @since 7.10.5
 */
if (!class_exists('RafflePress_Notifications')) {
    class RafflePress_Notifications
    {
         ...
         * @var string
         */
        const SOURCE_URL = 'https://seedprod-notifications.s3.amazonaws.com/rp-notifications.json';
         ...
         * @var string
         */
        public $option_name = 'rafflepress_notifications';
        ...
        /**
         * RafflePress_Notifications constructor.
         */
        ...
        {
            add_action('wp_ajax_rafflepress_lite_notification_dismiss', array( $this, 'dismiss' ));
        }
        ...
        public function has_access()
        {
            ...
            return apply_filters('rafflepress_admin_notifications_has_access', $access);
        }
        ...
        { // phpcs:ignore Generic.Metrics.CyclomaticComplexity.TooHigh
            ...
            if (! empty($option['dismissed']) && in_array($notification['id'], $option['dismissed'])) { // phpcs:ignore WordPress.PHP.StrictInArray.MissingTrueStrict
                ...
                // Ignore if notification existed before installing RafflePress.
                // Prevents bombarding the user with notifications after activation.
                $over_time = get_option('rafflepress_over_time', array());
        ...
        // Run a security check.
            check_ajax_referer('rafflepress_lite_notification_dismiss', '_wpnonce');
        ...
        {
            if ($this->get_count() > 0) {
                return '<span class="rafflepress-menu-notification-indicator"></span>';
            }
        ...
        public function get_view_url()
        {
            ...
            $url = add_query_arg('page', 'rafflepress_reports', admin_url('admin.php'));

            if (false !== $disabled) {
                $url = is_multisite() ? network_admin_url('admin.php?page=rafflepress_network') : admin_url('admin.php?page=rafflepress_settings');
            }
...
//add_action( 'rafflepress_notification', array( 'RafflePress_Notifications', 'update' ) );
if (!function_exists('rafflepress_lite_do_notifications_remote')) {

    add_action('rafflepress_notifications_remote', 'rafflepress_lite_do_notifications_remote');
    function rafflepress_lite_do_notifications_remote()
    {
