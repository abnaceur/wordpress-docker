...
function rafflepress_lite_admin_footer($text)
{
    ...
    if (!empty($current_screen->id) && strpos($current_screen->id, 'rafflepress') !== false) {
        ...
        $text = sprintf(__('Please rate <strong>RafflePress</strong> <a href="%s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the RafflePress team!', 'rafflepress'), $url, $url);
    }
    return $text;
}
