 ...
 *  Get IP
 */
function rafflepress_lite_get_ip()
{
    $ip = '';
...
{
    $entry_options = array(
        'visit-fb' => array('name'=>__('Visit us on Facebook','rafflepress'),'is_pro'=> false,'cat'=>'subscribers'),
        'twitter-follow' => array('name'=>__('Follow us on Twitter','rafflepress'),'is_pro'=> false ,'cat'=>'subscribers'),
        'instagram-follow' => array('name'=>__('Visit us on Instagram','rafflepress'),'is_pro'=> false ,'cat'=>'subscribers'),
        'pinterest-follow' => array('name'=>__('Follow us on Pinterest','rafflepress'),'is_pro'=> false ,'cat'=>'subscribers'),
        'linkedin-follow' => array('name'=>__('Follow us on LinkedIn','rafflepress'),'is_pro'=> true ,'cat'=>'subscribers'),
        'youtube-follow' => array('name'=>__('Visit a YouTube Channel','rafflepress'),'is_pro'=> true ,'cat'=>'subscribers'),
        'join-newsletter' => array('name'=>__('Join an Email Newsletter','rafflepress'),'is_pro'=> true ,'cat'=>'subscribers'),


        'refer-a-friend' => array('name'=>__('Refer a Friend - Viral','rafflepress'),'is_pro'=> true,'cat'=>'engagement'),
        'fb-page-post' => array('name'=>__('View Facebook Post / Video','rafflepress'),'is_pro'=> true,'cat'=>'engagement'),
        'instagram-page-post' => array('name'=>__('View Instagram Post / Video','rafflepress'),'is_pro'=> true,'cat'=>'engagement'),
        'watch-a-video' => array('name'=>__('Watch a Video','rafflepress'),'is_pro'=> true  ,'cat'=>'engagement'),
        'automatic-entry' => array('name'=>__('Automatic Entry','rafflepress'),'is_pro'=> true,'cat'=>'engagement'),
        
        
        'tweet' => array('name'=>__('Tweet a Message','rafflepress'),'is_pro'=> false ,'cat'=>'traffic'),
        'visit-a-page' => array('name'=>__('Visit a Page','rafflepress'),'is_pro'=> false ,'cat'=>'traffic'),
        'linkedin-share' => array('name'=>__('Share on LinkedIn','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
        'question' => array('name'=>__('Answer a Question','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
        'polls-surveys' => array('name'=>__('Polls & Surveys','rafflepress'),'is_pro'=> true, 'cat'=>'traffic') ,
        'submit-image' => array('name'=>__('Submit an Image','rafflepress'),'is_pro'=> true, 'cat'=>'traffic') ,
        'invent-your-own' => array('name'=>__('Invent Your Own','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
        'comment' => array('name'=>__('Leave a Comment','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
        'blogpost' => array('name'=>__('Write a Blog Post','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
        'rss' => array('name'=>__('Subscribe to RSS Feed','rafflepress'),'is_pro'=> true ,'cat'=>'traffic'),
    );
...
{
    $times = array();
    $times[] = array('v'=> '', 'l'=> __('Select Time', 'rafflepress'));
...
* Multiple inserts
*/
function rafflepress_lite_wp_insert_rows($row_arrays = array(), $wp_table_name, $update = false, $primary_key = null)
{
    global $wpdb;
