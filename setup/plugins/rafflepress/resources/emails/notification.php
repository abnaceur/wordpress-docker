...
<body style="<?php echo $style['body'] ?>">
    ...
    ?>
        ...
        ?>
                                        ...
                                        <?php if (!empty($daily_results_running)) {
        ?>
                                        <strong><?php _e('Running', 'rafflepress'); ?></strong><br>
                                        <ul>
                                            <?php foreach ($daily_results_running as $v) {
            ?>
                                        ...
                                        <?php if (!empty($daily_results_ended)) {
        ?>
                                        <strong><?php _e('Ended', 'rafflepress'); ?></strong><br>
                                        <ul>
                                            <?php foreach ($daily_results_ended as $v) {
            ?>
                                            <li style="font-size:13px"><?php echo $v->name ?> -
                                        ...
                                        <?php if (!empty($weekly_results_running)) {
        ?>
                                        <strong><?php _e('Running', 'rafflepress'); ?></strong><br>
                                        <ul>
                                            <?php foreach ($weekly_results_running as $v) {
            ?>
                                            <li style="font-size:13px"><?php echo $v->name ?> -
                                                <?php echo $v->contestants_count ?>
                                                <?php _e('new contestants and', 'rafflepress'); ?>
                                        ...
                                        <?php if (!empty($weekly_results_ended)) {
        ?>
                                        <strong><?php _e('Ended', 'rafflepress'); ?></strong><br>
                                        <ul>
                                            <?php foreach ($weekly_results_ended as $v) {
            ?>
                                            <li style="font-size:13px"><?php echo $v->name ?> -
                                                <?php _e('with', 'rafflepress'); ?>
                                                <?php echo $v->contestants_count ?>
